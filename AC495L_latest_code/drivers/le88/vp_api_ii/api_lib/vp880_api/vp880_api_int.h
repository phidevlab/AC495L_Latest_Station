...
/**< Bit definitions for Interrupt Mask Command */
        /**< Byte 1 */
#define VP880_MASK_CFAIL_INT    0x80    /**< Clock Fail */
#define VP880_MASK_POH1_INT     0x40    /**< Parallel Off-Hook */
#define VP880_MASK_OCALMY_INT   0x40    /**< Overcurrent Alarm */
#define VP880_MASK_POL1_INT     0x20    /**< Polarity Reversal */
#define VP880_MASK_TEMPA1_INT   0x20    /**< Overtemperature Alarm */
#define VP880_MASK_IO2_1_INT    0x10    /**< IO2 input change */
#define VP880_MASK_CAD1_INT     0x08    /**< Cadence Timer */
#define VP880_MASK_DISC1_INT    0x04    /**< Disconnect Detected */
#define VP880_MASK_CID1_INT     0x04    /**< Caller ID Ready */
#define VP880_MASK_RGDT1_INT    0x02    /**< Ringing on FXO */
#define VP880_MASK_GKEY1_INT    0x02    /**< Ring to Ground detected on FXS */
#define VP880_MASK_LIU1_INT     0x01    /**< Line-In-Use Detected */
#define VP880_MASK_HOOK1_INT    0x01    /**< Loop Close */

        /**< Byte 2 */
#define VP880_MASK_ATI_INT      0x80    /**< Arm Transmit Ready Interrupt */
#define VP880_MASK_POH2_INT     0x40    /**< Parallel Off-Hook */
#define VP880_MASK_OCALMZ_INT   0x40    /**< Overcurrent Alarm */
#define VP880_MASK_POL2_INT     0x20    /**< Polarity Reversal */
#define VP880_MASK_TEMPA2_INT   0x20    /**< Overtemperature Alarm */
#define VP880_MASK_IO2_2_INT    0x10    /**< IO2 input change */
#define VP880_MASK_CAD2_INT     0x08    /**< Cadence Timer */
#define VP880_MASK_DISC2_INT    0x04    /**< Disconnect Detected */
#define VP880_MASK_CID2_INT     0x04    /**< Caller ID Ready */
#define VP880_MASK_RGDT2_INT    0x02    /**< Ringing on FXO */
#define VP880_MASK_GKEY2_INT    0x02    /**< Ring to Ground detected on FXS */
#define VP880_MASK_LIU2_INT     0x01    /**< Line-In-Use Detected */
#define VP880_MASK_HOOK2_INT    0x01    /**< Loop Close */
...
#define VP880_CODEC_MASK        0x01    /**< CODEC exists if set in PCN */
#define VP880_WIDEBAND_MASK     0x02    /**< Wideband if set in PCN */
...
typedef enum {
    /**< One Channel Devices */
    VP880_FIRST_OF_ONE_CHANNEL_DEVICES = 0x05,

    VP880_DEV_PCN_88010 = 0x06,     /**< FXO */
    VP880_DEV_PCN_88016 = 0x07,     /**< FXO - Wideband */

    VP880_DEV_PCN_88110 = 0x09,     /* FXS-Tracker */
    VP880_DEV_PCN_88111 = 0x0A,     /* FXS-Tracker */
    VP880_DEV_PCN_88116 = 0x0B,     /* FXS-Tracker - Wideband */
    VP880_DEV_PCN_88130 = 0x0D,     /* FXS-Tracker */
    VP880_DEV_PCN_88131 = 0x0E,     /* FXS-Tracker */
    VP880_DEV_PCN_88136 = 0x0F,     /* FXS-Tracker - Wideband */

    VP880_LAST_OF_ONE_CHANNEL_DEVICES = 0x10,

    /** Two Channel Devices */
    VP880_FIRST_OF_TWO_CHANNEL_DEVICES = 0x80,

    VP880_DEV_PCN_88320 = 0x81,     /* FXO/FXS-ABS */
    VP880_DEV_PCN_88321 = 0x82,     /* FXO/FXS-ABS */
    VP880_DEV_PCN_88326 = 0x83,     /* FXO/FXS-ABS - Wideband */
    VP880_DEV_PCN_88340 = 0x85,     /* FXO/FXS-ABS */
    VP880_DEV_PCN_88341 = 0x86,     /* FXO/FXS-ABS */
    VP880_DEV_PCN_88346 = 0x87,     /* FXO/FXS-ABS - Wideband */

    VP880_DEV_PCN_88020 = 0xA6,     /* 2FXO */
    VP880_DEV_PCN_88026 = 0xA7,     /* 2FXO */

    VP880_DEV_PCN_88310 = 0xA9,     /* FXO/FXS-Tracker */
    VP880_DEV_PCN_88311 = 0xAA,     /* FXO/FXS-Tracker */
    VP880_DEV_PCN_88316 = 0xAB,     /* FXO/FXS-Tracker - Wideband */
    VP880_DEV_PCN_88330 = 0xAD,     /* FXO/FXS-Tracker */
    VP880_DEV_PCN_88331 = 0xAE,     /* FXO/FXS-Tracker */
    VP880_DEV_PCN_88336 = 0xAF,     /* FXO/FXS-Tracker - Wideband */

    VP880_DEV_PCN_88220 = 0xB1,     /* 2FXS-ABS */
    VP880_DEV_PCN_88221 = 0xB2,     /* 2FXS-ABS */
    VP880_DEV_PCN_88226 = 0xB3,     /* 2FXS-ABS - Wideband */
    VP880_DEV_PCN_88240 = 0xB5,     /* 2FXS-ABS */
    VP880_DEV_PCN_88241 = 0xB6,     /* 2FXS-ABS */
    VP880_DEV_PCN_88246 = 0xB7,     /* 2FXS-ABS - Wideband */

    VP880_DEV_PCN_88210 = 0xB9,     /* 2FXS-Tracker */
    VP880_DEV_PCN_88211 = 0xBA,     /* 2FXS-Tracker */
    VP880_DEV_PCN_88216 = 0xBB,     /* 2FXS-Tracker - Wideband */
    VP880_DEV_PCN_88230 = 0xBD,     /* 2FXS-Tracker */
    VP880_DEV_PCN_88231 = 0xBE,     /* 2FXS-Tracker */
    VP880_DEV_PCN_88236 = 0xBF,     /* 2FXS-Tracker - Wideband */

    VP880_LAST_OF_TWO_CHANNEL_DEVICES = 0xC0,

    VP880_PCN_ENUM_SIZE = FORCE_STANDARD_C_ENUM_SIZE /* Portability Req.*/
} Vp880PcnType;
...
/**< Internal Switching Regulator Parameters Command bit equations */

/*
 * Note:  It is very important that the part not be programmed with on-time of
 * > 85% of the mode's period.  Programming larger times can result in damage
 * to the external switching transistor and/or inductor/transformer.
 */
#define VP880_SWREG_MAXON_DIVISOR   100ul
#define VP880_SWREG_MAXON_PERIOD    85ul

#define VP880_SWREG_LPOT_DIVISOR    100ul
#define VP880_SWREG_LPOT_STEPSIZE   179ul   /**< 1.79uS/step */

#define VP880_SWREG_LPMP_DIVISOR    10ul
#define VP880_SWREG_LPMP_STEPSIZE   407ul   /**< 40.7nS/step */

#define VP880_SWREG_MPOT_DIVISOR    100ul
#define VP880_SWREG_MPOT_STEPSIZE   179ul   /**< 1.79uS/step */

#define VP880_SWREG_MPMP_DIVISOR    10ul
#define VP880_SWREG_MPMP_STEPSIZE   407ul   /**< 40.7nS/step */

#define VP880_SWREG_HPOT_DIVISOR    100ul
#define VP880_SWREG_HPOT_STEPSIZE   407ul   /**< 40.7nS/step */

#define VP880_SWREG_HPMP_DIVISOR    10ul
#define VP880_SWREG_HPMP_STEPSIZE   407ul   /**< 40.7nS/step */
...
#define VP880_SWZ_MODE_MASK         0xC0
...
#define VP880_SS_BALANCED_RINGING   (0x07 | VP880_SS_ACTIVATE_MASK)
#define VP880_SS_LOW_GAIN           (0x08 | VP880_SS_ACTIVATE_MASK)
#define VP880_SS_RSVD_0             (0x09 | VP880_SS_ACTIVATE_MASK)
#define VP880_SS_UNBALANCED_RINGING (0x0A | VP880_SS_ACTIVATE_MASK)
...
/**< Automatic Battery Switch Shutdown */
...
#define VP880_OPCOND_RSVD_MASK      0x0A
...
/* Position in DC Profile specifying VOC */
...
#define VP880_DC_FEED_VOC_DIVISOR       100ul
#define VP880_DC_FEED_VOC_STEPSIZE      268ul

#define VP880_DC_FEED_VAS_DIVISOR       100ul
#define VP880_DC_FEED_VAS_STEPSIZE      294ul

#define VP880_DC_FEED_ILA_DIVISOR       1ul
#define VP880_DC_FEED_ILA_STEPSIZE      1ul
...
#define VP880_SW_RESET_CMD      0x02    /**< Software reset */
