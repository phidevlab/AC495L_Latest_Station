...
#undef VP880_INTERRUPT_EDGETRIG_MODE    /* Define to use edge triggered 
                                         * interrupt handling mode */
#define  VP880_INCLUDE_TESTLINE_CODE     /* Defines whether or not to enable
...
#undef EZ_MPI_PCM_COLLECT            /* Define to use api to collect
...
#define VP_PCM_CALCULATION_TIME 1000     /* time is in ms */
...
/* CSLAC-880 and DVP-880 do not support the detection of AC, DC critical faults.
