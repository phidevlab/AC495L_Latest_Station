...
#define MAX_REPLACEMENT     40

#define REPLACING_START             \
    char _chars[MAX_REPLACEMENT];   \
    int _charsCnt = 0;              \
	char* _pos[MAX_REPLACEMENT];
...
RvBool rvSdpEncodeVcId(RvChar* txt, RvInt* txtLen, struct _RvSdpMediaDescr *md);
