...
/*
 * RvSipViaHeaderFieldName
 * ----------------------------
 * This enum defines all the Via header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_VIA_FIELD_HOST           = 0,
	RVSIP_VIA_FIELD_PORT           = 1,
	RVSIP_VIA_FIELD_TRANSPORT      = 2,
    RVSIP_VIA_FIELD_RPORT_PARAM    = 3,
	RVSIP_VIA_FIELD_MADDR_PARAM    = 4,
	RVSIP_VIA_FIELD_RECEIVED_PARAM = 5,
	RVSIP_VIA_FIELD_BRANCH_PARAM   = 6,
	RVSIP_VIA_FIELD_COMP_PARAM     = 7,
	RVSIP_VIA_FIELD_OTHER_PARAMS   = 8,
	RVSIP_VIA_FIELD_TTL_PARAM      = 9,
	RVSIP_VIA_FIELD_HIDDEN_PARAM   = 10,
	RVSIP_VIA_FIELD_ALIAS_PARAM    = 11,
	RVSIP_VIA_FIELD_BAD_SYNTAX     = 12,
	RVSIP_VIA_FIELD_SIPGCOMPID_PARAM = 13
}RvSipViaHeaderFieldName;
 ...
 ***************************************************************************/
RVAPI RvStatus RVCALLCONV RvSipViaHeaderIsEqual(const RvSipViaHeaderHandle hHeader,
 ...
 * ------------------------------------------------------------------------
 * General: Copies the SigCompId parameter from the Via header object into a
 *          given buffer. If the bufferLen size is adequate, the function
 *          copies the parameter into the strBuffer. Otherwise, the function
 *          returns RV_ERROR_INSUFFICIENT_BUFFER and the actualLen parameter contains
 *          the required buffer length.
