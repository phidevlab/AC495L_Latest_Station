...
/*
 * RvSipAllowEventsHeaderFieldName
 * ----------------------------
 * This enum defines all the Allow-Events header fields.
...
typedef enum
{
	RVSIP_ALLOW_EVENTS_FIELD_EVENT_TYPE   = 0,
	RVSIP_ALLOW_EVENTS_FIELD_BAD_SYNTAX
}RvSipAllowEventsHeaderFieldName;
