...
#define PQUEUE_CELL_EVAILABLE       2
 ...
 *          preemptionLocation - the preemption location i nthe queue
 * Output:  none
 ***********************************************************************************/
RVAPI void RVCALLCONV PQUEUE_SetPreemptionLocation(IN RV_PROCESSING_QUEUE	hQueue,
                                                   IN RvUint8               preemptionLocation);
