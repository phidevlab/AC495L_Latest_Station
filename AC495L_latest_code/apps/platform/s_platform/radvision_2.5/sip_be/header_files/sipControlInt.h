...
*  ---------------------------------
*  General :        Calls user callback for regsitering stack events that IPP TK
*                   doesn't listen on.
*
*  Return Value:   None
*
...
*  Output:         none.
******************************************************************************/
void rvIppSipExtRegisterStackEventsCB(RvIppSipControlHandle  sipMgrHndl, RvSipStackHandle stackHandle);
...
void rvIppSipExtPostCallLegCreatedOutgoingCB(RvIppSipControlHandle sipMgrHndl, 
											 RvSipCallLegHandle hCallLeg);
