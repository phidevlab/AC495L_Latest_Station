...
typedef enum
{
	...
	RVSIP_AUTHENTICATION_INTEGRITY_KEY,
	RVSIP_AUTHENTICATION_CIPHER_KEY,
...
/*
 * RvSipAuthenticationHeaderFieldName
 * ----------------------------
 * This enum defines all the Authentication header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_AUTHENTICATION_FIELD_AUTHSCHEME	= 0,
	RVSIP_AUTHENTICATION_FIELD_REALM		= 1,
	RVSIP_AUTHENTICATION_FIELD_DOMAIN		= 2,
	RVSIP_AUTHENTICATION_FIELD_NONCE		= 3,
	RVSIP_AUTHENTICATION_FIELD_OPAQUE		= 4,
	RVSIP_AUTHENTICATION_FIELD_ALGORITHM	= 5,
	RVSIP_AUTHENTICATION_FIELD_QOP			= 6,
	RVSIP_AUTHENTICATION_FIELD_STALE		= 7,
	RVSIP_AUTHENTICATION_FIELD_OTHER_PARAMS	= 8,
	RVSIP_AUTHENTICATION_FIELD_BAD_SYNTAX	= 9,
	RVSIP_AUTHENTICATION_FIELD_AKA_VERSION	= 10,
	RVSIP_AUTHENTICATION_FIELD_INTEGRITY_KEY= 11,
	RVSIP_AUTHENTICATION_FIELD_CIPHER_KEY	= 12
}RvSipAuthenticationHeaderFieldName;
 ...
 *          Authentication header object. Parameters with no specific fields are referred to as
 ...
 *          object. Parameters with no specific fields are referred to as other params. They
