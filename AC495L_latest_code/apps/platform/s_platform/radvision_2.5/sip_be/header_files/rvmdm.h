...
typedef enum
{
    ...
    RV_MDMTERMREASON_REMOTE_REJECTED,/* 3 - remote rejected the request (outgoing)*/
    RV_MDMTERMREASON_LOCAL_FAILED    /* 4 - local failed (incoming)*/
} RvMdmTermReasonModifyMedia;


typedef void RvMdmXTermMgr;
typedef void RvMdmXTerm;
typedef void RvMdmXApp;
...
/*$
{private_callback:
    {name: RvMdmXTermEnableOOBDtmfRelayCB}
    {include: rvmdm.h}
    {description:
        {p: Function type of callback to process events.}

    }
    {proto: void (*RvMdmXTermEnableOOBDtmfRelayCB)(RvMdmTerm* term,RvBool enabled); }
    {params:
        {param: {n:term} {d:A pointer to termination object.}}
        {param: {n:enable} {d:rvTrue - enable, rvFalse - disable.}}
    }
}
$*/
typedef void (*RvMdmXTermEnableOOBDtmfRelayCB)(struct RvMdmTerm_ * term,RvBool enabled);

/*$
{private_callback:
    {name: RvMdmXTermSetPhoneNumberCB}
    {include: rvmdm.h}
    {description:
        {p: Function type of callback to process events.}

    }
    {proto: void (*RvMdmXTermSetPhoneNumberCB)(RvMdmTerm* term,const char* number); }
    {params:
        {param: {n:term} {d:A pointer to termination object.}}
        {param: {n:pkg} {d:number: the phone number.}}
    }
}
$*/
typedef RvStatus (*RvMdmXTermSetPhoneNumberCB)(
    IN struct RvMdmTerm_*   term,
...
/*{private_callback:
    {name: RvMdmXTermModifyMediaCB}
    {include: rvmdm.h}
    {description:
        {p: Function type of callback to process events.}

    }
    {proto: void (*RvMdmXTermModifyMediaCB)(RvMdmXTerm* term, RvSdpMsg* sdpMsg);
    }
    {params:
        {param: {n:term} {d:A pointer to the concrete termination.}}
        {param: {n:sdpMsg} {d:A pointer to SDP message that includes new media parameters.}}

    }
}
$*/
typedef RvBool (*RvMdmXTermModifyMediaCB)(struct RvMdmTerm_* term, RvSdpMsg* sdpMsg);

/*{private_callback:
    {name: RvMdmXTermSetPresentationInfoCB}
    {include: rvmdm.h}
    {description:
        {p: Function type of callback to set presentation info.}

    }
    {proto: void (*RvMdmXTermSetPresentationInfoCB)(RvMdmXTerm* term, RvMdmTermPresentationInfo* presentationInfo);
    }
    {params:
        {param: {n:term} {d:A pointer to the concrete termination.}}
        {param: {n:presentationInfo} {d:The presentation information.}} }
    }
}
$*/
typedef RvBool (*RvMdmXTermSetPresentationInfoCB)(struct RvMdmTerm_* term,
                                    RvMdmTermPresentationInfo* presentationInfo);

/*$
{private_callback:
    {name: RvMdmXTermInternalMatchDigitMapCB}
    {include: rvmdm.h}
    {description:
        {p: Checks for matching of a dial string to a digitmap. This function will be called
            by the termination callback if the user did not register a different one.}
    }
    {proto: const char* (*RvMdmXTermInternalMatchDigitMapCB)(RvMdmXTerm* xTerm);}
    {params:
        {param: {n:xTerm} {d:Pointer to concrete termination.}}
        {param: {n:dialString} {d:The dial string to match.}}
        {param: {n:timeDuration} {d:Output time duration.}}
    }
    {returns:
        The matching result.
    }
...
$*/
typedef RvMdmDigitMapMatchType (*RvMdmXTermInternalMatchDigitMapCB)(RvMdmXTerm* xTerm, const char* dialString, unsigned int* timeDuration);
...
typedef struct
{
    ...
    RvMdmXTermInternalMatchDigitMapCB           internalMatchDigitMapF;
    RvMdmXTermEnableOOBDtmfRelayCB              enableOOBDtmfRelayF;
    RvMdmXTermSetPhoneNumberCB                  setPhoneNumberF;
    RvMdmXTermModifyMediaCB                     modifyMediaF;
    RvMdmXTermSetPresentationInfoCB             setPresentationInfoF;
} RvMdmXTermClbks;
...
/*$
{function:
    {name: rvMdmTermEnableOutOfBandDtmfRelay}
    {class: RvMdmTerm}
    {include: rvmdm.h}
    {description:
        {p: Enable the sending of Out Of Band Dtmf relay.}
    }
    {proto: void rvMdmTermEnableOutOfBandDtmfRelay(RvMdmTerm* term,RvBool enabled); }
    {params:
        {param: {n:term} {d:A pointer to termination object.}}
        {param: {n:pkg} {d:rvTrue - enable, rvFalse - disable.}}
    }
}
$*/
RVAPI void rvMdmTermEnableOutOfBandDtmfRelay(RvMdmTerm* term,RvBool enabled);
...
{function:
    ...
    {include: rvmdm.h}
    {description:
        {p: Request to modify parameters of existing media during a call.}
    }
...
/*$
{function:
    {name: rvMdmTermSetPresentationInfo}
    {class: RvMdmTerm}
    {include: rvmdm.h}
    {description:
        {p: Change configuration of presentation name and permissions in terminal.}
    }
    {proto: void rvMdmTermSetPresentationInfo(RvMdmTerm* term, RvMdmTermPresentationInfo* presentationInfo); }
    {params:
        {param: {n:term} {d:A pointer to termination object.}}
        {param: {n:presentationInfo} {d:The new presentation information object.}}
    }
}
$*/
...
RvMdmDigitMapMatchType rvMdmTermInternalMatchDigitMap(RvMdmTerm* term, const char* dialString, unsigned int* timeDuration);
