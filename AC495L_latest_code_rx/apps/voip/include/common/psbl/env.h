...
#endif
#else
#define ENV_SPACE_SIZE      (32 * 1024) /*ACL Allen 20110115 save space for private labeling*/
#endif
...
#define CONFIG_TRACK_ENV_OP
#ifdef CONFIG_TRACK_ENV_OP
#define ENV_CNT_PARAM	"env_cnt"
#endif
