 ...
 *                          in the system since one thread terminated ubnormaly.
 ***************************************************************************/
 ...
 * Output:
 ***********************************************************************************/
void RVCALLCONV TransportCallbackTLSStateChange(IN TransportConnection*                 pConn,
...
* Input:   pTransportMgr    - A pointer to the transport manager object.
*          pConn            - pointer to the created connection.
*          strAliasName     - The connection alias, as was received in the top via header.
*                             (the alias is sent-by field in the via header. e.g. in this header
*                             "Via: SIP/2.0/TLS 10.54.32.1:5061; branch=z9hG4bKa7c8dze; alias"
*                              the alias is "10.54.32.1:5061").
*          pTlsCertificate  - Pointer to the TLS certificate of the connection. (Application
*                             should use it for authentication).
* Output:  none.
***************************************************************************/
