...
#define RV_MTF_VERSION   "Multimedia Terminal Framework Version 2.5.1.54 Copyright (c) RADVISION"
...
/*  RvCCTerminal                 */
/*===============================*/
#define RV_CCTERMINAL_MAXCONNS      3/*5*/
...
typedef struct
{
    ...
    RvInt32                     displayRow;
    struct RvCCTerminalFuncs_*  funcs;
...
/*-----------------------------------------------------------------------
 ...
 ------------------------------------------------------------------------*/
char* rvCCTerminalGetId(RvCCTerminal* x);
typedef char* (*RvCCTerminalGetIdF)(RvCCTerminal* x);

/* return true if the audio termination exist*/
RvBool rvCCTerminalIsAudioTerminationExist(RvCCTerminal* t,RvCCTerminalAudioType audio);
typedef RvBool (*RvCCTerminalIsAudioTerminationExistF)(RvCCTerminal* x,RvCCTerminalAudioType audio);

/* Switch the audio to the desired output */
/* Note: default audio is handset */
void rvCCTerminalSetActiveAudio(RvCCTerminal* x,RvCCTerminalAudioType audio);
typedef void (*RvCCTerminalSetActiveAudioF)(RvCCTerminal* x,RvCCTerminalAudioType audio);

/* Get the active audio */
RvCCTerminalAudioType rvCCTerminalGetActiveAudio(RvCCTerminal* x);
typedef RvCCTerminalAudioType (*RvCCTerminalGetActiveAudioF)(RvCCTerminal* x);

RvCCTerminal* rvCCTerminalGetActiveAudioTerm(RvCCTerminal* x);
typedef RvCCTerminal* (*RvCCTerminalGetActiveAudioTermF)(RvCCTerminal* x);

void rvCCTerminalSetActiveAudioTerm(RvCCTerminal* t, RvCCTerminal* at);
typedef void (*RvCCTerminalSetActiveAudioTermF)(RvCCTerminal* t, RvCCTerminal* at);

RvCCTerminal* rvCCTerminalGetActiveVideoCamTerm(RvCCTerminal* x);
typedef RvCCTerminal* (*RvCCTerminalGetActiveVideoCamTermF)(RvCCTerminal* x);

RvCCTerminal* rvCCTerminalGetActiveVideoScrTerm(RvCCTerminal* x);
typedef RvCCTerminal* (*RvCCTerminalGetActiveVideoScrTermF)(RvCCTerminal* x);

void rvCCTerminalSetActiveVideoCamTerm(RvCCTerminal* t, RvCCTerminal* at);
typedef void (*RvCCTerminalSetActiveVideoCamTermF)(RvCCTerminal* t, RvCCTerminal* at);

void rvCCTerminalSetActiveVideoScrTerm(RvCCTerminal* t, RvCCTerminal* at);
typedef void (*RvCCTerminalSetActiveVideoScrTermF)(RvCCTerminal* t, RvCCTerminal* at);

void rvCCTerminalStopSignals(RvCCTerminal* x);
typedef void (*RvCCTerminalStopSignalsF)(RvCCTerminal* x);

RvBool rvCCTerminalStartDialToneSignal(RvCCTerminal* x);
typedef RvBool (*RvCCTerminalStartDialToneSignalF)(RvCCTerminal* x);

RvBool rvCCTerminalStartRingingSignal(RvCCTerminal* x);
typedef RvBool (*RvCCTerminalStartRingingSignalF)(RvCCTerminal* x);

RvBool rvCCTerminalStopRingingSignal(RvCCTerminal* x);
typedef RvBool (*RvCCTerminalStopRingingSignalF)(RvCCTerminal* x);

RvBool rvCCTerminalStartRingbackSignal(RvCCTerminal* x);
typedef RvBool (*RvCCTerminalStartRingbackSignalF)(RvCCTerminal* x);

RvBool rvCCTerminalStartCallWaitingSignal(RvCCTerminal* x);
typedef RvBool (*RvCCTerminalStartCallWaitingSignalF)(RvCCTerminal* x);

RvBool rvCCTerminalStartCallWaitingCallerSignal(RvCCTerminal* x);
typedef RvBool (*RvCCTerminalStartCallWaitingCallerSignalF)(RvCCTerminal* x);

RvBool rvCCTerminalStartBusySignal(RvCCTerminal* x);
typedef RvBool (*RvCCTerminalStartBusySignalF)(RvCCTerminal* x);

RvBool rvCCTerminalStartWarningSignal(RvCCTerminal* x);
typedef RvBool (*RvCCTerminalStartWarningSignalF)(RvCCTerminal* x);

RvBool rvCCTerminalStartDTMFTone(IN RvCCTerminal* x, IN RvDtmfParameters* dtmfParam);
typedef RvBool (*RvCCTerminalStartDTMFToneF)(IN RvCCTerminal* x, IN RvDtmfParameters* dtmfParam);

RvBool rvCCTerminalStopDTMFTone(RvCCTerminal* x, RvChar digit);
typedef RvBool (*RvCCTerminalStopDTMFToneF)(RvCCTerminal* x, RvChar digit);

RvBool rvCCTerminalSetHoldInd(RvCCTerminal* x, RvBool on);
typedef RvBool (*RvCCTerminalSetHoldIndF)(RvCCTerminal* x, RvBool on);

RvBool rvCCTerminalSetMuteInd(RvCCTerminal* x, RvBool on);
typedef RvBool (*RvCCTerminalSetMuteIndF)(RvCCTerminal* x, RvBool on);

RvBool rvCCTerminalSetAudioInd(RvCCTerminal* x, char* id, int state);
typedef RvBool (*RvCCTerminalSetAudioIndF)(RvCCTerminal* x, char* id, int state);

RvBool rvCCTerminalSetLineInd(RvCCTerminal* x, int lineId, RvCCTerminalIndState state);
typedef RvBool (*RvCCTerminalSetLineIndF)(RvCCTerminal* x, int lineId, RvCCTerminalIndState state);

RvBool rvCCTerminalSendLineActive(RvCCTerminal* x, int lineId, RvBool active);
typedef RvBool (*RvCCTerminalSendLineActiveF)(RvCCTerminal* x, int lineId, RvBool active);

RvBool rvCCTerminalSetDisplay(
    IN RvCCTerminal*    x,
    IN const RvChar*    text,
    IN RvInt32          row,
    IN RvInt32          column);
typedef RvBool (*RvCCTerminalSetDisplayF)(
    IN RvCCTerminal*    x,
    IN const RvChar*    text,
    IN RvInt32          row,
    IN RvInt32          column);

RvBool rvCCTerminalClearDisplay(RvCCTerminal* x);
typedef RvBool (*RvCCTerminalClearDisplayF)(RvCCTerminal* x);

RvBool rvCCTerminalSendCallerId(RvCCTerminal* x, const char* callerName,
                               const char* callerNumber,const char* address,const char* callerId);
typedef RvBool (*RvCCTerminalSendCallerIdF)(
                RvCCTerminal* x,
...
void rvCCTerminalSetWaitForDigits(RvCCTerminal* x);
typedef void (*RvCCTerminalSetWaitForDigitsF)(RvCCTerminal* x);

char* rvCCTerminalGetDialString(RvCCTerminal* x);
typedef char* (*RvCCTerminalGetDialStringF)(RvCCTerminal* x);

void rvCCTerminalResetDialString(RvCCTerminal* x);
typedef void (*RvCCTerminalResetDialStringF)(RvCCTerminal* x);

void rvCCTerminalInstallDigitMap(RvCCTerminal* x);
typedef void (*RvCCTerminalInstallDigitMapF)(RvCCTerminal* x);


/******************************************************************************
*  rvCCTerminalIsOutOfBandDtmfEnabled
*  ----------------------------
*  General :        get the status of OOD according the configuration file
*
*  Return Value:    rvTrue(supported),rvFalse(not supported).
*
*  ----------------------------------------------------------------------------
*  Arguments:
...
*
******************************************************************************/
RvBool rvCCTerminalIsOutOfBandDtmfEnabled(RvCCTerminal* t);
typedef RvBool (*RvCCTerminalIsOutOfBandDtmfEnabledF)(RvCCTerminal* t);

RvBool rvCCTerminalIsDtmfPlayEnabled(RvCCTerminal* t);
typedef RvBool (*RvCCTerminalIsDtmfPlayEnabledF)(RvCCTerminal* t);

int rvCCTerminalGetMaxConnections(RvCCTerminal* t);
typedef int (*RvCCTerminalGetMaxConnectionsF)(RvCCTerminal* t);

typedef RvCCTerminalEvent (*RvCCTerminalMapEventF)(RvCCTerminal* t, const char* pkg, const char* id,
                                    RvMdmParameterList * args, char* key);

typedef struct RvCCTerminalFuncs_
{
    RvCCTerminalGetIdF                      getIdF;
    RvCCTerminalIsAudioTerminationExistF    isAudioTerminationExist;
    RvCCTerminalSetActiveAudioF             setActiveAudioF;
    RvCCTerminalGetActiveAudioF             getActiveAudioF;
    RvCCTerminalSetActiveAudioTermF         setActiveAudioTermF;
    RvCCTerminalGetActiveAudioTermF         getActiveAudioTermF;
    RvCCTerminalGetActiveVideoCamTermF      getActiveVideoCamTermF;
    RvCCTerminalGetActiveVideoScrTermF      getActiveVideoScrTermF;
    RvCCTerminalSetActiveVideoCamTermF      setActiveVideoCamTermF;
    RvCCTerminalSetActiveVideoScrTermF      setActiveVideoScrTermF;
    RvCCTerminalStopSignalsF                stopSignalsF;
    RvCCTerminalStartDialToneSignalF        startDialToneF;
    RvCCTerminalStartRingingSignalF         startRingingSignalF;
    RvCCTerminalStopRingingSignalF          stopRingingSignalF;
    RvCCTerminalStartRingbackSignalF        startRingbackSignalF;
    RvCCTerminalStartCallWaitingSignalF     startCallWaitingSignalF;
    RvCCTerminalStartCallWaitingCallerSignalF   startCallWaitingCallerSignalF;
    RvCCTerminalStartBusySignalF            startBusySignalF;
    RvCCTerminalStartWarningSignalF         startWarningSignalF;
    RvCCTerminalStartDTMFToneF              startDTMFToneF;
    RvCCTerminalStopDTMFToneF               stopDTMFToneF;
    RvCCTerminalSetHoldIndF                 setHoldIndF;
    RvCCTerminalSetMuteIndF                 setMuteIndF;
    RvCCTerminalSetAudioIndF                setAudioIndF;
    RvCCTerminalSetLineIndF                 setLineIndF;
    RvCCTerminalSendLineActiveF             sendLineActiveF;
    RvCCTerminalSetDisplayF                 setDisplayF;
    RvCCTerminalClearDisplayF               clearDisplayF;
    RvCCTerminalSendCallerIdF               sendCallerIdF;
    RvCCTerminalSetWaitForDigitsF           setWaitForDigitsF;
    RvCCTerminalMapEventF                   mapEventF;
    RvCCTerminalGetDialStringF              getDialStringF;
    RvCCTerminalResetDialStringF            resetDialStringF;
    RvCCTerminalInstallDigitMapF            installDigitMapF;
    RvCCTerminalIsOutOfBandDtmfEnabledF     isOutOfBandDtmfEnabled;
    RvCCTerminalIsDtmfPlayEnabledF          isDtmfPlayEnabled;
    RvCCTerminalGetMaxConnectionsF          getMaxConnectionsF;
} RvCCTerminalFuncs;
...
#define rvCCConnectionSetMediaState(x,s) ((x)->mediaState=(s))
...
RvBool rvCCConnectionCheckPartyMedia(RvCCConnection* x);
typedef RvBool (*RvCCConnectionCheckPartyMediaF)(RvCCConnection* x);
...
typedef RvBool (*RvCCConnectionTermCheckPartyMediaF)(RvCCConnection* x);
RvBool *RvCCConnectionTermCheckPartyMedia(RvCCConnection* x);
...
typedef void (*RvCCConnectionDialingCB)(RvCCConnection* x);
void rvCCConnectionDialingCB(RvCCConnection* x);
...
typedef struct RvCCConnectionFuncs_
{
    ...
    RvCCConnectionTermCheckPartyMediaF   checkPartyMediaF;
...
typedef struct RvCCConnectionClbks_
{
    ...
    RvCCConnectionDialingCB         dialingCB;
