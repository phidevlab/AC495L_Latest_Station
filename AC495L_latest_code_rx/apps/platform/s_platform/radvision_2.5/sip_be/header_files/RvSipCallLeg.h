 ...
 *          called in any state. The behavior of the function depends on
 *          the following call-leg states:
 ...
 *          URI incudes the comp=sigcomp parameter.
 * Return Value: RvStatus
 * ------------------------------------------------------------------------
 * Arguments:
 * Input:     hCallLeg     - The call-leg handle.
 ...
 *          remote party, the call-leg will use this agreement and the data
