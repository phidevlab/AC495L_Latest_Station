...
/*
 * RvSipRAckHeaderFieldName
 * ----------------------------
 * This enum defines all the RAck header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_RACK_FIELD_STEP          = 0,
	RVSIP_RACK_FIELD_METHOD        = 1,
	RVSIP_RACK_FIELD_RESPONSE_NUM  = 2,
	RVSIP_RACK_FIELD_BAD_SYNTAX    = 3
}RvSipRAckHeaderFieldName;
 ...
 * ------------------------------------------------------------------------
 * Arguments:
 * Input:  hSipMsg		    - Handle to the message related to the new
 *							  header object.
 *		   pushHeaderAtHead - A Boolean value indicating whether the header 
 ...
 * ------------------------------------------------------------------------
 * General: Checks if the response num value in the RAck header object is
 *		    defined. 
 * Return Value: RvStatus
 * ------------------------------------------------------------------------
 * Arguments:
 *    hHeader   - Handle to the RAck header object.
 *	  pbInit    - Indication of the response number definition.
 ***************************************************************************/
 ...
 * Return Value: Returns the response number value.
 * ------------------------------------------------------------------------
 * Arguments:
 *    hHeader - Handle to the RAck header object.
 ***************************************************************************/
 ...
 * ------------------------------------------------------------------------
 * General:Sets the response number value in the RAck header object.
 * Return Value: Returns RvStatus.
 * ------------------------------------------------------------------------
 * Arguments:
 *    hHeader	   - Handle to the RAck header object.
 ...
 * ------------------------------------------------------------------------
 * General: Gets the Cseq Handle from, the RAck header.
