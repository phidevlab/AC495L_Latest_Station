...
/*
 * RvSipSubscriptionStateHeaderFieldName
 * ----------------------------
 * This enum defines all the Subscription-State header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_SUBSCRIPTION_STATE_FIELD_STATE = 0,
	RVSIP_SUBSCRIPTION_STATE_FIELD_REASON = 1,
	RVSIP_SUBSCRIPTION_STATE_FIELD_EXPIRES = 2,
	RVSIP_SUBSCRIPTION_STATE_FIELD_RETRY_AFTER = 3,
	RVSIP_SUBSCRIPTION_STATE_FIELD_OTHER_PARAMS = 4,
	RVSIP_SUBSCRIPTION_STATE_FIELD_BAD_SYNTAX = 5
}RvSipSubscriptionStateHeaderFieldName;
