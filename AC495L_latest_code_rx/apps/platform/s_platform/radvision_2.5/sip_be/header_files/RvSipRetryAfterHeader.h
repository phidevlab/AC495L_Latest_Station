...
/*
 * RvSipRetryAfterHeaderFieldName
 * ----------------------------
 * This enum defines all the Retry-After header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_RETRY_AFTER_FIELD_RETRY_AFTER  = 0,
	RVSIP_RETRY_AFTER_FIELD_DURATION     = 1,
	RVSIP_RETRY_AFTER_FIELD_COMMENT      = 2,
    RVSIP_RETRY_AFTER_FIELD_OTHER_PARMAS = 3,
	RVSIP_RETRY_AFTER_FIELD_BAD_SYNTAX   = 4
}RvSipRetryAfterHeaderFieldName;
