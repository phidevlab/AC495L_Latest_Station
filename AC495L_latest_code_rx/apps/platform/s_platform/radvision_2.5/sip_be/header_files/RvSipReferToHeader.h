...
/*
 * RvSipReferToHeaderFieldName
 * ----------------------------
 * This enum defines all the Refer-To header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_REFER_TO_FIELD_ADDR_SPEC    = 0,
	RVSIP_REFER_TO_FIELD_REPLACES     = 1,
    RVSIP_REFER_TO_FIELD_OTHER_PARMAS = 2,
	RVSIP_REFER_TO_FIELD_BAD_SYNTAX   = 3
}RvSipReferToHeaderFieldName;
