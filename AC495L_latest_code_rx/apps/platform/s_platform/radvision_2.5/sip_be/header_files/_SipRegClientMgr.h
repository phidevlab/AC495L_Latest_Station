 ...
 ***************************************************************************/
void RVCALLCONV SipRegClientGetSctpMsgSendingParams(
                    IN  RvSipRegClientHandle               hRegClient,
