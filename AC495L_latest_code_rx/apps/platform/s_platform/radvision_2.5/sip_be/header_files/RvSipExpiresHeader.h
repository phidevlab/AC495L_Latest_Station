...
/*
 * RvSipExpiresHeaderFieldName
 * ----------------------------
 * This enum defines all the Expires header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_EXPIRES_FIELD_DELTA_SECONDS  = 0,
	RVSIP_EXPIRES_FIELD_DATE           = 1,
	RVSIP_EXPIRES_FIELD_BAD_SYNTAX     = 2
}RvSipExpiresHeaderFieldName;
