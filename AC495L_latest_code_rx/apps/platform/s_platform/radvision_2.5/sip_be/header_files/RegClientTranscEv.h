 ...
 ***************************************************************************/
void RVCALLCONV RegClientTranscEvStateChanged(
 ...
 ***************************************************************************/
RvStatus RVCALLCONV RegClientTranscEvMsgToSend(
                                       IN RvSipTranscHandle   hTransaction,
                                          IN RvSipTranscOwnerHandle  hRegClient,
 ...
 *                         used anymore (by the "owner" of this callback).
 ***************************************************************************/
RvStatus RVCALLCONV RegClientTranscEvMsgReceived (
                                          IN RvSipTranscHandle   hTransaction,
                                               IN RvSipTranscOwnerHandle  hRegClient,
 ...
 *                             resolving.
 ***************************************************************************/
RvStatus RVCALLCONV RegClientTranscEvOtherURLAddressFound(
...
/***************************************************************************
 * RegClientTranscFinalDestResolvedEv
 * ------------------------------------------------------------------------
 ...
 ***************************************************************************/
RvStatus RVCALLCONV RegClientTranscFinalDestResolvedEv(
                            IN RvSipTranscHandle       hTransc,
                            IN RvSipTranscOwnerHandle  hRegClient,
                            IN RvSipMsgHandle          hMsgToSend);
 ...
 ***************************************************************************/
RvStatus RVCALLCONV RegClientTranscNewConnInUseEv(
                     IN  RvSipTranscHandle              hTransc,
                     IN  RvSipTranscOwnerHandle         hRegClient,
...
#ifdef RV_SIGCOMP_ON
/***************************************************************************
 * RegClientTranscSigCompMsgNotRespondedEv
 * ------------------------------------------------------------------------
 ...
 ***************************************************************************/
RvStatus RVCALLCONV RegClientTranscSigCompMsgNotRespondedEv(
                     IN  RvSipTranscHandle            hTransc,
                     IN  RvSipTranscOwnerHandle       hRegClient,
