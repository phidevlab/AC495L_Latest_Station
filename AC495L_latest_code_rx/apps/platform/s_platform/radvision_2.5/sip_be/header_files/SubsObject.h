 ...
 *                    will be set to the new reuqest it will send.
*/
 ...
 * Subscription is a stateful object and has a set of states associated
 * with it.
 *
 ...
 *                  this parameter helps us to decide wether to change state to active
 ...
 * eSubsType   --   The type parameter indicates whether the call-leg represents
 ...
 * autoRefresh --   Defines wether to send an automatic refresh request, when an alert is given.
 ...
 *                  will decide wether to set this timer or not.
 ...
 * subsUniqueIdentifier -- unique identifier for this subscription. created for each new
 *                    subscription. Is useful for the locking procedures.
 ...
 * eSubstate   --   The substate from subscription-state header of the notify message.
 ...
 * hSubscriptionStateHeader - The subscription-State headre to set in the NOTIFY request.
...
***************************************************************************/
RvStatus RVCALLCONV GetExpiresValFromMsg(RvSipMsgHandle hMsg, RvInt32* pexpiresVal);
...
#ifdef RV_SIGCOMP_ON
/***************************************************************************
 * SubsResetSigCompDataForDestChange
 * ------------------------------------------------------------------------
 ...
 ***************************************************************************/
RvStatus RVCALLCONV SubsResetSigCompDataForDestChange(IN Subscription* pSubs);
#endif /* RV_SIGCOMP_ON */
