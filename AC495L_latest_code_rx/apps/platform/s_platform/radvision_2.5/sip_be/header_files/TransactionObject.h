...
typedef struct
{
    ...
    RvSipTransportObjEventInfo  msgSendFailureInfo;
                                            /* Information required for the object termination
    ...
    RvInt32                     transactionUniqueIdentifier;/* A unique identifier for this transaction
                                                              (randomly generated when the transaction is created.*/
...
#ifdef RV_SIGCOMP_ON
    SipTransportSigCompMsgInfo       sigCompUDVMInfo;     /* The transport SigComp info. about */
                                                          /* an incoming message */
...
#ifdef RV_SIGCOMP_ON
/***************************************************************************
 * TransactionSetCompartment
 * ------------------------------------------------------------------------
 * General: Associates the Transaction to a SigComp Compartment.
 * Return Value: RvStatus
 * ------------------------------------------------------------------------
 * Arguments:
 * Input:     pTransc - The transaction handle.
 ...
 ***************************************************************************/
RvStatus RVCALLCONV TransactionSetCompartment(
                            IN Transaction           *pTransc,
                            IN RvSipCompartmentHandle hCompartment);

/***************************************************************************
 * TransactionHandleIncomingSigCompTransc
 * ------------------------------------------------------------------------
 * General: The function should be called when a SigComp-SIP message is
 *          received/sent. According to the SigComp model each SigComp-SIP
 ...
 * Input:     pTransc - The transaction handle.
 ***************************************************************************/
RvStatus RVCALLCONV TransactionHandleIncomingSigCompTransc(
                                       IN Transaction *pTransc);

/***************************************************************************
* TransactionStoreSigCompInfo
* ------------------------------------------------------------------------
* General: Store all the SigComp information related to the transaction
* Return Value: Returns RvStatus.
* ------------------------------------------------------------------------
* Arguments:
* input: pTransc         - Pointer to the transaction.
*        pSigCompInfo    - Pointer to the SigComp information.
***************************************************************************/
void RVCALLCONV TransactionStoreSigCompInfo(
                                  IN Transaction                *pTransc,
