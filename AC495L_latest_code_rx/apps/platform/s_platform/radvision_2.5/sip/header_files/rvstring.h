...
RVAPI RvString* rvStringConstructN(RvString *x, const char *str, RvSize_t n, RvAlloc *a);
RvString* rvStringConstructAndReserve(RvString *x, RvSize_t n, RvAlloc *sdpAllocator);
RVAPI RvString* rvStringConstructCopy(RvString *d, const RvString *s, RvAlloc *a);
RVAPI void rvStringDestruct(RvString *x);
...
RVAPI RvString* rvStringAssign(RvString *x, const char* str);
...
RVAPI RvBool rvStringEqual(const RvString *a, const RvString *b);
RvBool rvStringEqualIgnoreCase(const RvString *a, const RvString *b);
RVAPI RvBool rvStringLess(const RvString *a, const RvString *b);
