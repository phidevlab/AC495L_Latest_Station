...
#ifndef REG_CLIENT_DNS_H
#define REG_CLIENT_DNS_H
 ...
 * ------------------------------------------------------------------------
 * Arguments:
 * Input:     pRegClient - reg-client which is responsible for the message.
 ***************************************************************************/
RvStatus RVCALLCONV RegClientDNSGiveUp (IN  RegClient*   pRegClient);

/***************************************************************************
 * RegClientDNSContinue
 * ------------------------------------------------------------------------
 ...
 * Input:     pRegClient - reg client which is responsible for the message.
 ***************************************************************************/
RvStatus RVCALLCONV RegClientDNSContinue (IN  RegClient* pRegClient);

/***************************************************************************
 * RegClientDNSReSendRequest
 * ------------------------------------------------------------------------
 * General: This function is for use at MSG_SEND_FAILURE state.
 ...
 *          REFER messages.
 * Return Value: RV_ERROR_INVALID_HANDLE -  The handle to the reg-client is invalid.
 *                 RV_ERROR_ILLEGAL_ACTION - Invalid reg-client state for this action.
 ...
 * ------------------------------------------------------------------------
 * Arguments:
 * Input:     pRegClient - call leg which is responsible for the message.
 ***************************************************************************/
RvStatus RVCALLCONV RegClientDNSReSendRequest (IN  RegClient* pRegClient);
...
***************************************************************************/
RvStatus RVCALLCONV RegClientDNSGetList(
...
#endif /* END OF: #ifndef REG_CLIENT_DNS_H*/
