 ...
 * RvSipMsgFieldName
 * ----------------------------
 * This enum defines all the Msg fields.
 * It is used for getting and setting via RvSipAddress interface.
 */
typedef enum
{
	RVSIP_MSG_FIELD_METHOD                 = 0,
	RVSIP_MSG_FIELD_REQUEST_URI            = 1,
	RVSIP_MSG_FIELD_STATUS_CODE            = 2,
	RVSIP_MSG_FIELD_REASON_PHRASE          = 3,
	RVSIP_MSG_FIELD_BODY                   = 4	
 ...
 * Arguments:
 * input: hSipMsg    - Handle to the message object.
 *        bIsCompact - specifies whether or not compact form is used
 ***************************************************************************/
