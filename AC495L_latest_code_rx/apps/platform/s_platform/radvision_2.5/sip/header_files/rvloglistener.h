...
/* Error checks to make sure configuration has been done properly */
    ...
    (RV_LOGLISTENER_TYPE != RV_LOGLISTENER_UDP_AND_TERMINAL) && \
...
#if (RV_LOGLISTENER_TYPE == RV_LOGLISTENER_UDP) ||(RV_LOGLISTENER_TYPE == RV_LOGLISTENER_UDP_AND_TERMINAL)
...
/*  EA - 080207 VI#60671 Setting Syslog IP address for application logs through GUI */
#elif (RV_LOGLISTENER_TYPE == RV_LOGLISTENER_UDP) ||(RV_LOGLISTENER_TYPE == RV_LOGLISTENER_UDP_AND_TERMINAL)
	void*  logUdpListener;
#endif
} RvLogListener;
