...
#if (RV_OS_VERSION == RV_OS_MAC_DARWIN_8_0_0)
#define RV_OS_STRING "MAC Darwin 8.0.0"
#else
...
#define RV_SEMAPHORE_STRING "MAC"
...
#elif (RV_LOGLISTENER_TYPE == RV_LOGLISTENER_UDP_AND_TERMINAL)
#define RV_LOGLISTENER_STRING "UDP&Term"
