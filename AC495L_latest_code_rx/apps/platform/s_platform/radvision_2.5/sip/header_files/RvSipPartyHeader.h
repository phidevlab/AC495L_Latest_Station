...
/*
 * RvSipPartyHeaderFieldName
 * ----------------------------
 * This enum defines all the Party header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_PARTY_FIELD_ADDR_SPEC    = 0,
    RVSIP_PARTY_FIELD_TAG          = 1,
	RVSIP_PARTY_FIELD_OTHER_PARMAS = 2,
	RVSIP_PARTY_FIELD_BAD_SYNTAX   = 3
}RvSipPartyHeaderFieldName;
 ...
 *            existing tag is removed from the header.
 ***************************************************************************/
 ...
 * ------------------------------------------------------------------------
 * General: Instructs the header to use the compact party header name, when 
 *          the party header is encoded.
 * Return Value: Returns RvStatus.
 * ------------------------------------------------------------------------
 * Arguments:
 * input: hHeader    - The Handle to the Party header object.
 *        bIsCompact - Specifies whether or not to use a compact form
 ***************************************************************************/
