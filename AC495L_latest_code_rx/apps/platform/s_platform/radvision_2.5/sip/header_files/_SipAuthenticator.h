...
/******************************************************************************
 * SipAuthenticatorCheckValidityOfAuthObj
 * ----------------------------------------------------------------------------
 * General: goes throuth list of Authentication Data structures and for each
 *          structure checks, if the challenge, contained in the structure's
 *          Authentication header is supported by the Stack.
 * Return Value: RV_OK on success,
 ...
 *                     RV_TRUE otherwise.
 *****************************************************************************/
RvStatus RVCALLCONV SipAuthenticatorCheckValidityOfAuthObj(
                                       IN  RvSipAuthenticatorHandle hAuthMgr,
                                       IN  AuthObjListInfo          *pAuthListInfo,
                                       IN  RLIST_HANDLE             hList,
                                        OUT RvBool                   *pbValid);
