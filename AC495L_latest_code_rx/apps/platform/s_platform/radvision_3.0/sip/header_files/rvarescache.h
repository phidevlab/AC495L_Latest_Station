...
#define RvAresCacheDFind(cached, qtype, name, nameSize, domainSuffixes, nDomains, domainMask, cb, cbCtx, qid, qBuf, qBufSize) \
    ((void)(cached), (void)qtype, (void)(name), (void)(nameSize), (void)(domainSuffixes), (void)nDomains, (void)domainMask, \
    (void)(cb), (void)(cbCtx), (void)(qid), (void)(qBuf), (void)(qBufSize), (RV_DNS_ERROR_CACHE_NOTFOUND))
...
#define RvAresCacheCltFind(env, qtype, name, nameSize, domainSuffixes, nDomains, domainMask,  cb, cbCtx, qid, qBuf, pQbufSize) \
    RvAresCacheDFind((env)->cached, qtype, name, nameSize, domainSuffixes, nDomains, domainMask, cb, cbCtx, qid, qBuf, pQbufSize)
