...
/*For Coral BLF*/
RVAPI RvStatus RVCALLCONV RvSipSubsMgrCreateSubscriptionByType(
                                   IN  RvSipSubsMgrHandle  hSubsMgr,
                                   IN  RvSipCallLegHandle  hCallLeg,
                                   IN  RvSipAppSubsHandle  hAppSubs,
...
/*For Coral BLF*/
RVAPI RvStatus RVCALLCONV RvSipSubsHandleSubsRequest (IN  RvSipSubsHandle hSubs,
 ...
 *          uncapable of handling this new subscription at all, for example in an
