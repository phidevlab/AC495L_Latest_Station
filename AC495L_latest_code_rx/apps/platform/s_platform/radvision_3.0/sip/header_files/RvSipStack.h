 ...
 * ----------------------------------------------------------------------------------
 * General: Gets the Publish-client Manager handle. You need this handle in order to use
 *          the Publish-client API functions.
 * Return Value: Returns RvStatus.
 * ----------------------------------------------------------------------------------
 * Arguments:
 * Input:   hStack          - Handle to the RADVISION SIP stack.
...
#endif /* #if !defined(RV_SIP_PRIMITIVES) */
