...
void rvSdpMsgDestructForReuse(
            RvSdpMsg* msg,
            RvBool    sessDescrOnly); /* If RV_FALSE, media descriptors will be destructed also */
...
/*
 *	Compare not common fileds of two RvSdpMediaDescr instances.
 *  Returns RV_TRUE, if they are equal.
 */
RvBool rvSdpMediaDescrCompareNotCommonFileds(
