...
#define DEFAULT_MAX_PUB_CLIENTS        2
...
#define DEFAULT_CLIENT_ALERT_TIMER	   5000
...
#define STACK_NUM_OF_LOG_SOURCE_MODULES 41
 ...
 * hPubClientMgr       - handle to the pub client manager
