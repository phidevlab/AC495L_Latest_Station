...
/*
 * RvSipContentDispositionHeaderFieldName
 * ----------------------------
 * This enum defines all the Content-Disposition header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_CONTENT_DISPOSITION_FIELD_TYPE           = 0,
	RVSIP_CONTENT_DISPOSITION_FIELD_HANDLING       = 1,
	RVSIP_CONTENT_DISPOSITION_FIELD_OTHER_PARAMS   = 2,
	RVSIP_CONTENT_DISPOSITION_FIELD_BAD_SYNTAX     = 3
}RvSipContentDispositionHeaderFieldName;
