...
/*
 * RvSipEventHeaderFieldName
 * ----------------------------
 * This enum defines all the Event header fields.
 * It is used for getting and setting via RvSipHeader interface.
 * Notice: There is no seperation into Event-Package and Event-Template, since
 *         JSR32 handles them both in Event-Type.
 */
typedef enum
{
	RVSIP_EVENT_FIELD_EVENT_TYPE         = 0,
	RVSIP_EVENT_FIELD_EVENT_ID           = 1,
	RVSIP_EVENT_FIELD_EVENT_OTHER_PARAMS = 2,
	RVSIP_EVENT_FIELD_EVENT_BAD_SYNTAX   = 3
}RvSipEventHeaderFieldName;
