...
/* RTP related parameters */
    RvSocket                  rtpSock;              /* socket of RTP Multiplexing session   */
    RvSelectEngine*           rtpSelectEngine;      /* RTP select engine                    */
    RvSelectFd                rtpSelectFd;          /* shared FD for RTP session            */
...
/* RTCP related parameters */    
    RvSocket                  rtcpSock;             /* socket of RTP Multi session          */
    RvSelectEngine*           rtcpSelectEngine;     /* RTCP select engine                   */
    RvSelectFd                rtcpSelectFd;         /* shared FD for RTCP sessions          */
