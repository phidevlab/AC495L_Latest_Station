...
//ACL NB 100429 VI83018 UnattendedTransfer issue- Received from RV at Apr 29th 2010
	RV_CCCALL_TRANSFER_SEMI_NO_CANCEL,	/* 3 */
	RV_CCCALL_TRANSFER_FULL		/* 4 */
...
typedef struct RvCCCall_
{
	...
	RvMutex					lock;
	RvUint32                lockCnt;                /* counts how many times mutex were locked */
} RvCCCall;
...
RvStatus rvCCCallSendBlindTransferToMdmStateMachine( RvCCConnection* conn, RvChar* destination);
