...
#define RV_TIMESTAMP_OSA 14
#define RV_TIMESTAMP_MAC 15
...
#define RV_SEMAPHORE_MOPI 7
#define RV_SEMAPHORE_OSA 8
#define RV_SEMAPHORE_CONDVAR 9
#define RV_SEMAPHORE_NONE 10 /* No effect, single threaded environment only */
...
#define RV_MUTEX_OSA 7
#define RV_MUTEX_MANUAL 100
#define RV_MUTEX_NONE 101 /* No locking, single threaded environment only */
...
#define RV_THREAD_OSA 11
#define RV_THREAD_NONE 12 /* Work as single threaded only */

/* rvmutex: RV_LOCK_TYPE - Select Lock interface to use */
#define RV_LOCK_SOLARIS 0
#define RV_LOCK_POSIX 1
...
#define RV_LOCK_OSA 8
#define RV_LOCK_MANUAL 9 /* Just use a semaphore */
#define RV_LOCK_NONE 10 /* No locking, single threaded environment only */
...
/* rvldap: RV_LDAP_TYPE - Select LDAP interface to use */
#define RV_LDAP_NONE 0
#define RV_LDAP_OPENLDAP 1
...
#define RV_SELECT_KQUEUE 6
#define RV_SELECT_EPOLL 7
...
#define RV_PORTRANGE_DEFAULT_START  49152	/* set the dynamic port range (http://www.iana.org/assignments/port-numbers) */
#define RV_PORTRANGE_DEFAULT_FINISH 65535   /* for Nucleus - used in rvsocket.c */
...
#define RV_LOGLISTENER_UDP_AND_TERMINAL 4  /* Support UDP and Terminal listeners */
#define RV_LOGLISTENER_NONE 5              /* Support none of the sample listeners */
...
#define RV_SQRT_NONE     0
#define RV_SQRT_STANDARD 1
#define RV_SQRT_ALGR     2
#define RV_SQRT_MBORG    4
#define RV_SQRT_FAST     8
#define RV_SQRT_FRED     16
#define RV_SQRT_ALL      (RV_SQRT_STANDARD | RV_SQRT_ALGR | RV_SQRT_MBORG | RV_SQRT_FAST | RV_SQRT_FRED)

#define RV_THREAD_TLS_MANUAL 1
#define RV_THREAD_TLS_STANDARD 0
