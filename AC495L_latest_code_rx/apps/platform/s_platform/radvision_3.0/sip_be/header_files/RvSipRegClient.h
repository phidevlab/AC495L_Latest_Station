 ...
 * ------------------------------------------------------------------------
 * General: Sets a set of event handlers identified with the application for a certain reg-client.
 * Return Value:   RV_OK - The event handlers were successfully set otherwise error occurred.
 * ------------------------------------------------------------------------
 * Arguments:
 * Input:		hRegClient - A handle to the RegClient to set the handlers to.
...
RVAPI RvStatus RVCALLCONV RvSipRegClientSetEvHandlers(
                        ...
                        IN RvSipRegClientEvHandlers			*pHandlers,
