 ...
 * vp_api_fxo_params.h
 *
 * This file contains the Legerity approved system parameters for proper
 * FXO operation on the reference designs
 *
 * Copyright (c) 2005, Legerity Inc.
 * All rights reserved
 *
 * This software is the property of Legerity , Inc  which specifically  grants
 * the user the right to modify, use and distribute this software provided this
 * notice is not removed or altered.  All other rights are reserved by Legerity.
 */
