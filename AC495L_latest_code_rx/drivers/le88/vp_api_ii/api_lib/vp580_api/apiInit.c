    ...
    Vp580DeviceObjectType *pDevObj)
{
    ...
    for (objSize = 0;
         objSize < (sizeof(Vp580DeviceObjectType) / sizeof(uint8));
         objSize++) {
    ...
    Vp580LineObjectType *pLineObj)
{
    ...
    for (objSize = 0;
         objSize < (sizeof(Vp580LineObjectType) / sizeof(uint8));
         objSize++) {
    ...
    VpDevCtxType *pDevCtx)
{
    ...
    VpMpiCmd(deviceId, VP580_EC_CH1, VP580_HW_RESET_CMD, NO_DATA, &data);
    ...
    VpMpiCmd(deviceId, VP580_EC_CH1, VP580_MCLK_CNT_WRT, VP580_MCLK_CNT_LEN,
        &data);
    ...
    while(clkNotStable && (--clkTestCount) != 0) {
        ...
        VpMpiCmd(deviceId, VP580_EC_CH1, VP580_IODIR_REG_RD,
    ...
    VpMpiCmd(deviceId, VP580_EC_CH1, VP580_INT_MASK_WRT,
    ...
    VpMpiCmd(deviceId, VP580_EC_CH1, VP580_DEBOUNCE_TIME_WRT,
    ...
    VpMpiCmd(deviceId, VP580_EC_CH1, VP580_XR_CS_WRT, VP580_XR_CS_LEN, &data);
                                     ...
                                     */
{
     ...
     */
    VpMpiCmd(deviceId, VP580_EC_CH1, VP580_DEVTYPE_CMD,
                                     ...
                                     */
{
    ...
    if (pLineObj->status & VP580_IS_FXO) {
        pLineObj->lineState.current = VP_LINE_FXO_LOOP_OPEN;
    ...
    VpMpiCmd(deviceId, ecVal[channelId], VP580_SW_RESET_CMD, NO_DATA, &data);
    VpSysWait(3);
     ...
     */
    VpMpiCmd(deviceId, ecVal[channelId], VP580_IODIR_REG_WRT,
        VP580_IODIR_REG_LEN, ioDirection);
                                     ...
                                     */
{
    ...
    if (pAcProf != VP_PTABLE_NULL) {
        ...
        VpMpiCmd(deviceId, ecVal[channelId], VP580_OP_FUNC_RD,
            VP580_OP_FUNC_LEN, &data);
        data |= VP580_ENABLE_LOADED_COEFFICIENTS;
        VpMpiCmd(deviceId, ecVal[channelId], VP580_OP_FUNC_WRT,
            VP580_OP_FUNC_LEN, &data);
    }
    ...
    VpProfilePtrType pCustomTermProfile)
{
    ...
    int customIndex = GetProfileIndex(pCustomTermProfile);
    ...
    if ((customIndex >= 0) && (customIndex < VP_CSLAC_CUSTOM_TERM_PROF_TABLE_SIZE)) {
        ...
        if(VpVerifyProfileType(VP_PROFILE_CUSTOM_TERM, pCustomTermProfile) == TRUE) {
