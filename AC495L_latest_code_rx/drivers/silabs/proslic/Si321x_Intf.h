...
int Si321x_Cal_ACL (proslicChanType_ptr *hProslic, int size);//NIRP 070606
...
/* NIRP 070628
** Function: ACL_Si321x_GetCountryIndex
**
** Description: 
** Search in the FXS impedance structure for a mathing impedance for a given country name
**
** Input Parameters: 
** CountryName
** Return:
** Index of the country in the data base
*/
