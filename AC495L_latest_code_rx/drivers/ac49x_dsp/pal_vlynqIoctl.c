...
#undef LATEST_VLYNQ_REV
#define LATEST_VLYNQ_REV 0x00010204
...
static PAL_VLYNQ_IOCTL_INFO_T vlynq_reg32_ioctl[ ] = {
    ...
    { PAL_VLYNQ_IOCTL_ENDIAN_REG,   0x5c, "endian"       , 0xffffffff, 0x00010200, LATEST_VLYNQ_REV, 0        },
