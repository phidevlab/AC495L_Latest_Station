...
/*																					*/
/* Copyright (C) 2009 AudioCodes Ltd.												*/
/*																					*/
/* Modifications :																	*/
/*																					*/
...
extern void	Ac49xUserDef_RaffleAndTrashPacketBits(int Device, int Channel, char *_pPacket, int _PacketSize, Tac49xTransferMedium TransferMedium);
     ...
     * @ingroup FUNCTION_PROTOTYPES_AC491L
...
/* random access or auto-increment (multiplexed). */
     ...
     * @ingroup READ_WRITE_MACROS_AC491L
     * @brief 
     * Writes a 16-bit word to the AC491/AC491L/AC490 VoPP host port.
     * @{
     */
     ...
     *    
     * @n @b AC491L:
     * @n The @b Ac49xUserDef_WriteShort macro writes a 16-bit word to the AC491L VoPP host port. It is used 
     * by the ::Ac49xWriteBlock function. 
     * It writes a 16-bit word to one of the following registers: HPIA, HPID, HPIC, HPID (with post increment). 
     * @n @b Note: In the AC491L VoPP, every consecutive 2 devices (cores) share the same registers.
     * The AC491L device is a Big Endian machine. In Little Endian hosts the two 8-bit sections of the 16 bit 
     * data fields are inverted. This incompatibility can be resolved in two methods:
     * @li Software: Invert the data field bytes in this macro. @li Hardware: Invert the data pins in the hardware.
     * 
     * @n Big Endian
     ...
     * @ingroup READ_WRITE_MACROS_AC491L
     * @brief 
     * Reads a 16-bit word from the AC490/AC491/AC491L VoPP host port.
     * @{
     */
     ...
     * @b AC491L
     * @n The @b Ac49xUserDef_ReadShort macro
     * reads a 16-bit word from the AC491L VoPP host port. It is used by the ::Ac49xReadBlock function. 
     * It reads a 16-bit word from one of the following registers: HPIA, HPID, HPIC, HPID (with post increment). 
     * @n @b Note: In the AC491L VoPP, every consecutive 2 devices (cores) share the same registers.
     * 
     * @param Device  [in] The device in which the word is read from.
	...
	#define Ac49xUserDef_WriteShort(Device, Addr, Data) IO_WriteShort((unsigned long)(Addr##_Offset), Data, Ac49xGetNumberOfDsp(Device))
	#define Ac49xUserDef_ReadShort( Device, Addr)       IO_ReadShort( (unsigned long)(Addr##_Offset),       Ac49xGetNumberOfDsp(Device)) 
#endif
...
/*
    ...
    /**
     * @defgroup Ac49xUserDef_ClearPdcrRegister Ac49xUserDef_ClearPdcrRegister
     * @ingroup FUNCTION_PROTOTYPES_AC494E
     * @brief 
     * Clears the DSP core and the DSP peripherals bits in the @b PDCR Register (Power-Down Control Registers).
     * @{
     */

    /**
     * <BR>
     * @n The @b Ac49xUserDef_ClearPdcrRegister clears the DSP core and the DSP peripherals 
     * bits in the @b PDCR Register (Power-Down Control Registers). It takes out the DSP core and DSP perepherals from
     * power down mode. This function is called during program download.
     * 
     * @param 
     * This function has no parameters.
     * 
...
void Ac49xUserDef_ClearPdcrRegister();
    ...
    /**
     * @defgroup Ac49xUserDef_SetPrcrRegister Ac49xUserDef_SetPrcrRegister
     * @ingroup FUNCTION_PROTOTYPES_AC494E
     * @brief 
     * Sets the DSP core and DSP periherals bits in the @b PRCR Register (Peripheral Reset Control Register). 
     * @{
     */

    /**
     * <BR>
     * @n The @b Ac49xUserDef_SetPrcrRegister function sets the DSP core and DSP periherals bits in the 
     * @b PRCR Register (Peripheral Reset Control Register). It takes the DSP core and DSP peripherals out of reset.
     * This function is called during program download.
     *
     * @param GlxReset       [in] <ul> <li> 0 = Galaxy reset assert <li> 1 = Galaxy reset release </ul>. 
     * 
     * @par Return values:
     * @e None
     * 
...
void Ac49xUserDef_SetPrcrRegister(int GlxReset);
    ...
    /**
     * @defgroup Ac49xUserDef_InitCodec Ac49xUserDef_InitCodec
     * @ingroup FUNCTION_PROTOTYPES_AC494E
     * @brief 
     * Initializes the DSP internal codec.
     * @{
     */

    /**
     * <BR>
     * @n The @b Ac49xUserDef_InitCodec function initializes the DSP internal codec. It configures 
     * the @b Master @b CTRL register.
     * This function is called during program download.
     * 
     * @param 
     * This function has no parameters.
...
void Ac49xUserDef_InitCodec();
    ...
    /**
     * @defgroup Ac49xUserDef_InitInstructionCache Ac49xUserDef_InitInstructionCache
     * @ingroup FUNCTION_PROTOTYPES_AC494E
     * @brief 
     * Initializes the DSP internal cache.
     *
     * @{
     */
    ...
    /**
     * <BR>
     * @n The @b Ac49xUserDef_InitInstructionCache function initializes the DSP internal cache. It configures the SEGB field
     * in the @b CACHE @b SEGMENT register. The SEGB field maps the DSP cache to a specific location in
     * the external memory (DDR2).
     * This function is called during program download.
     *
     * @param  
     * This function has no parameters.
...
void Ac49xUserDef_InitInstructionCache();
    ...
    /**
     * @defgroup Ac49xUserDef_InitPcmSerialPort Ac49xUserDef_InitPcmSerialPort
     * @ingroup FUNCTION_PROTOTYPES_AC494E
     * @brief 
     * Enables the external TDM serial port input pins.
     *
     * @{
     */
    ...
    /**
     * <BR>
     * @n The @b Ac49xUserDef_InitPcmSerialPort function enables the external TDM serial port input pins.
     * The TDM serial port pins are enabled by writing to the @b PINSEL9 register.
     * This function is called during program download.
     *
     * @param 
     * This function has no parameters.
...
#endif /* (AC49X_DEVICE_TYPE == AC494E_DEVICE) || (AC49X_DEVICE_TYPE == AC495E_DEVICE) || (AC49X_DEVICE_TYPE == AC496D_DEVICE) */


    /**
     * @defgroup Ac49xUserDef_WriteLong Ac49xUserDef_WriteLong
     * @ingroup READ_WRITE_MACROS_AC494
     * @ingroup READ_WRITE_MACROS_AC494E
     * @brief 
...
#endif /* ((AC49X_DEVICE_TYPE != AC494_DEVICE) && (AC49X_DEVICE_TYPE != AC495_DEVICE) && (AC49X_DEVICE_TYPE != AC490_DEVICE) && (AC49X_DEVICE_TYPE != AC491_DEVICE)) && (AC49X_DEVICE_TYPE != AC491_491L_DEVICE)*/
