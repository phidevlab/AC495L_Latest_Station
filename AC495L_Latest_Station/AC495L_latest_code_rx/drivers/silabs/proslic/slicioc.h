...
#define SLICIOC_DEBUG_CMD				_IOW(SLIC_CMD_CODE, 0x97, voip_dsp_debug_cmd_t*)
#define SLICIOC_INIT_SLIC				_IOW(SLIC_CMD_CODE, 0x98, unsigned char)
#define SLICIOC_MWI_ACTIVATE	        _IOW(SLIC_CMD_CODE, 0x99, slic_mwi_params_t*)
...
#define SLICIOC_R_RING_END_DET          _IOR(SLIC_CMD_CODE, 0xA6, SET_UNSET*) /* ER06 */
#define SLICIOC_R_FXS_READ_DEFAULT_VAL  _IOR(SLIC_CMD_CODE, 0xA7, int*)
