...
EXTERN bool VpHalHbiWrite8(VpDeviceIdType deviceId, uint16 cmd, uint8 numwords, uint8p data);
EXTERN bool VpHalHbiRead8(VpDeviceIdType deviceId, uint16 cmd, uint8 numwords, uint8p data);
