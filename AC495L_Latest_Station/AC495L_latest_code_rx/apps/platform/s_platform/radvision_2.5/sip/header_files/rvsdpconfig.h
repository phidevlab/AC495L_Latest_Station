...
/* whether codecs are supported */
#define RV_SDP_CODECS_SUPPORTED
...
/* enables 'group' attribute & 'mid' attribute support */
#define RV_SDP_MEDIA_GROUPING_ATTR

/* enables 'MSRP' attribute */
#define RV_SDP_MSRP_ATTR

/* enables 'curr' 'des' & 'conf'attributes support */
#define RV_SDP_PRECONDITIONS_ATTR

/* enables 'rtcp' attribute support */
#define RV_SDP_RTCP_ATTR
/* enables SDP syntax extensions needed for Megaco/MGCP */
/*#define RV_SDP_MEGACO_ENABLED
*/
...
/*NirM, 080929 - Increase the size of the SDP buffer to avoid overflow */
#define RV_SDP_MSG_BUFFER_SIZE              1280/*1024 ACL NB 080925 VI66993 */
