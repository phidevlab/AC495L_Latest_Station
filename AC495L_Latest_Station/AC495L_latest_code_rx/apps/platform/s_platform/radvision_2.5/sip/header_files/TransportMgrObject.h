...
typedef struct  {
    ...
    RvUint16       port;        /*port of the outbound proxy*/
 ...
 * pPreemptionUsers     - Pointer to preemption array.
 * preemptionLocation   - Location of this transport manager in the preemption array
...
typedef struct {
    ...
    SipTransportTpqObjEventInfo*    pTpqObjEventList;
...
#endif /* RV_SIGCOMP_ON */
    void*                           pPreemptionUsers;
    RvUint8                         preemptionLocation;
#if (RV_NET_TYPE & RV_NET_SCTP)
