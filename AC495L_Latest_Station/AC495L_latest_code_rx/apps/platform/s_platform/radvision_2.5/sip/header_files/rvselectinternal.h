...
struct RvSelectFdInternal
{
     ...
     *
     *  2. ENABLE event is posted for this socket to the queue. In order to distinquish
...
/* This flag can be used only if Application creates RvThread object for each 
   thread. For now (4.5.0.19) there is no API, enabling the Application to
   create and destroy RvThread objects
*/
/*
