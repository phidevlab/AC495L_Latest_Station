...
/*      MTF DEFINITIONS                                */
/*-----------------------------------------------------*/
/* Disable any use of MEDIA. 
* Used in  MtfMediaCallbacks.c 
* MtfSipSample configuration - "...NoMedia" should be run with GUI configuration - "...NoMedia"  
*/
/*#define MTF_DISABLE_MEDIA*/

/*
* support G711 annex2. non-standard. Radvision TBU internal
*/
//#define MTF_SUPPORT_G711_ANNEX2
