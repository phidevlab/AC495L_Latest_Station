...
typedef struct
{
    ...
    RvSipTransportObjEventInfo                      stateInfo;
 ...
 * Output:  none
 *****************************************************************************/
void RVCALLCONV TransportConnectionChangeState(
           IN TransportConnection*                       pConn,
...
/***************************************************************************
* TransportConnectionApplyServerConnReuse
* ------------------------------------------------------------------------
* General: apply the connection-reuse procedure on the connection:
...
* Output: void
***************************************************************************/
RvStatus TransportConnectionApplyServerConnReuse(TransportConnection* pConn,
                                                RvSipMsgHandle       hMsg);
