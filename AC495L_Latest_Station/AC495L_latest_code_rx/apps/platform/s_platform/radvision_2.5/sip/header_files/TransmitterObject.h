 ...
 * strQuery         -- a cosecutive bufeer wit the string moved to the query
 ...
 * bFixVia          -- The application indicated that it whishes the transmitter to always
 ...
 * hMsgToSend       -- The message handle the transmitter is about to send.
 ...
 ***************************************************************************/
RvStatus RVCALLCONV TransmitterConnStateChangedEv(
            IN  RvSipTransportConnectionHandle             hConn,
 ...
 ***************************************************************************/
RvStatus RVCALLCONV TransmitterSetCompartment(
                            IN Transmitter               *pTrx,
                            IN RvSipCompartmentHandle hCompartment);

/***************************************************************************
 * TransmitterHandleSigCompTransmission
 * ------------------------------------------------------------------------
 * General: The function should be called when a SigComp-SIP message is
 *          sent/received. According to the SigComp model each SigComp-SIP
 ...
 ***************************************************************************/
RvStatus RVCALLCONV TransmitterHandleSigCompTransmission(
                                    IN Transmitter   *pTrx);
