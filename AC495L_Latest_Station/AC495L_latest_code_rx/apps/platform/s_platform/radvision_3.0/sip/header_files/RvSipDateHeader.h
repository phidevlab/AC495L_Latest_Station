...
/*
 * RvSipDateHeaderFieldName
 * ----------------------------
 * This enum defines all the Date header fields.
 * It is used for getting and setting via RvSipHeader interface.
 */
typedef enum
{
	RVSIP_DATE_FIELD_WEEK_DAY   = 0,
	RVSIP_DATE_FIELD_DAY        = 1,
	RVSIP_DATE_FIELD_MONTH      = 2,
	RVSIP_DATE_FIELD_YEAR       = 3,
	RVSIP_DATE_FIELD_HOUR       = 4,
	RVSIP_DATE_FIELD_MINUTE     = 5,
	RVSIP_DATE_FIELD_SECOND     = 6,
	RVSIP_DATE_FIELD_BAD_SYNTAX = 7	
}RvSipDateHeaderFieldName;
