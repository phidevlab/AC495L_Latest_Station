...
/***************************************************************************
 * RvSipRegClientObjExpiredEv
 * ------------------------------------------------------------------------
 * General:Notifies the application that the object is about to expire.
 *
 * Return Value: 
 * ------------------------------------------------------------------------
 * Arguments:
 * Input:     hRegClient     - Handle to the register client.
 *			  hAppRegClient  - Handle to the application register-client object.
 *            
 ***************************************************************************/
typedef void (RVCALLCONV *RvSipRegClientObjExpiredEv) (
                     IN  RvSipRegClientHandle           hRegClient,
					 IN  RvSipAppRegClientHandle        hAppRegClient);
...
typedef struct
{
	...
	RvSipRegClientObjExpiredEv			   pfnObjExpiredEvHandler;
#ifdef RV_SIGCOMP_ON
