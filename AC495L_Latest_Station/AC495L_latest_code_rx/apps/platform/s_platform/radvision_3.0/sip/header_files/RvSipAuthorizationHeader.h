...
/*
 * RvSipAuthorizationHeaderFieldName
 * ----------------------------
...
typedef enum
{
	RVSIP_AUTHORIZATION_FIELD_AUTHSCHEME   = 0,
	RVSIP_AUTHORIZATION_FIELD_USERNAME     = 1,
	RVSIP_AUTHORIZATION_FIELD_REALM        = 2,
	RVSIP_AUTHORIZATION_FIELD_NONCE        = 3,
	RVSIP_AUTHORIZATION_FIELD_CNONCE       = 4,
	RVSIP_AUTHORIZATION_FIELD_NONCE_COUNT  = 5,
	RVSIP_AUTHORIZATION_FIELD_URI          = 6,
	RVSIP_AUTHORIZATION_FIELD_OPAQUE       = 7,
	RVSIP_AUTHORIZATION_FIELD_ALGORITHM    = 8,
	RVSIP_AUTHORIZATION_FIELD_QOP          = 9,
	RVSIP_AUTHORIZATION_FIELD_RESPONSE     = 10,
	RVSIP_AUTHORIZATION_FIELD_OTHER_PARAMS = 11,
	RVSIP_AUTHORIZATION_FIELD_BAD_SYNTAX   = 12,
	RVSIP_AUTHORIZATION_FIELD_AUTS		   = 13
}RvSipAuthorizationHeaderFieldName;
 ...
 *          Authorization header object. Parameters with no specific fields are referred to as
