 ...
 * RvSipMidResources
 * --------------------
 * The resources used by the Mid module. Supply to 
 * RvSipMidGetResources() in order to obtain the resources status of the
 * Mid layer.
 *
 * userFds    - The resources status of the Mid file descriptors
 * userTimers - The resources status of the Mid timers
 */
typedef struct
{
