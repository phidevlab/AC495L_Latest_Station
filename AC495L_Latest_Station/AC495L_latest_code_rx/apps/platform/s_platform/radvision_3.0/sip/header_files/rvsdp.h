...
* Return Value:
*          The log handle or NULL
* ----------------------------------------------------------------------------------
* Arguments:
* Input:   None
* Output:  Log handle
***********************************************************************************/
RVSDPCOREAPI RV_LOG_Handle RVCALLCONV RvSdpGetLogHandle(void);
...
RVSDPCOREAPI RvSdpMsg* rvSdpMsgConstructCopy(
            ...
            const RvSdpMsg* src);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMsgConstructCopy(_dest,_src) rvSdpMsgCopy2((_dest),(_src),NULL,RV_FALSE,RV_FALSE)
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI RvSdpMsg* rvSdpMsgCopy(
            ...
            const RvSdpMsg* src);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMsgCopy(_dest,_src) rvSdpMsgCopy2((_dest),(_src),NULL,RV_TRUE,RV_FALSE)
#endif /*RV_SDP_USE_MACROS*/

/***************************************************************************
 * rvSdpMsgCopySessionDescription
 * ------------------------------------------------------------------------
 * General:
 *      Cleans destination message from any data and copies the Session
 *      Description fields into it from the source message.
 *      The Session Description part represents the RvSdpMsg message
 *      without Media Descriptors.
 *
 * Return Value:
 *      A pointer to the input RvSdpMsg object, or NULL if the function fails.
 * ------------------------------------------------------------------------
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpMsg* rvSdpMsgCopySessionDescription(
            RvSdpMsg* dest,
            const RvSdpMsg* src);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMsgCopySessionDescription(_dest,_src) rvSdpMsgCopy2(_dest,_src,NULL,RV_TRUE,RV_TRUE)
#endif /*RV_SDP_USE_MACROS*/
...
/***************************************************************************
 * rvSdpMediaDescrAddSpecAttr
 * ------------------------------------------------------------------------
 * General: 
 *      Add/set special attribue to media descriptor level.
 *      Only one special attr of this type is allowed per media!
 *      This function is not under any flags.It is currently used by 
 ...
 ***************************************************************************/
RVSDPCOREAPI RvSdpStatus rvSdpMediaDescrAddSpecAttr(
                                          RvSdpMediaDescr* descr, 
                                          const char     * val,
                                          RvSdpFieldTypes  fType);




#ifdef RV_SDP_MSRP_ATTR
/***************************************************************************
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpStatus rvSdpMediaDescrSetAcceptTypesVal(RvSdpMediaDescr* descr, 
                                                          const char     * val);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrSetAcceptTypesVal(_descr,_val) \
	(rvSdpMediaDescrAddSpecAttr(_descr,_val,SDP_FIELDTYPE_MSRP_ACC_TYPES))
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpStatus rvSdpMediaDescrSetAcceptWrappedTypesVal(RvSdpMediaDescr* descr, 
                                                                 const char     * val);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrSetAcceptWrappedTypesVal(_descr,_val) \
    (rvSdpMediaDescrAddSpecAttr(_descr,_val,SDP_FIELDTYPE_MSRP_ACC_WRAPPED_TYPES))
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpStatus rvSdpMediaDescrSetMaxSizeVal(RvSdpMediaDescr* descr, 
                                                      const char     * val);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrSetMaxSizeVal(_descr,_val) \
   (rvSdpMediaDescrAddSpecAttr(_descr,_val,SDP_FIELDTYPE_MSRP_MAX_SIZE))
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpStatus rvSdpMediaDescrSetPathVal(RvSdpMediaDescr* descr,
                                                   const char     * val);

#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrSetPathVal(_descr,_val) \
    (rvSdpMediaDescrAddSpecAttr(_descr,_val,SDP_FIELDTYPE_MSRP_PATH))
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI void rvSdpMediaDescrDestroyAcceptTypesAttr(RvSdpMediaDescr* descr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrDestroyAcceptTypesAttr(_descr) \
       rvSdpRemoveSpecialAttr(&(_descr)->iCommonFields,0,SDP_FIELDTYPE_MSRP_ACC_TYPES)
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI void rvSdpMediaDescrDestroyWrappedAcceptTypesAttr(RvSdpMediaDescr* descr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrDestroyWrappedAcceptTypesAttr(_descr) \
  rvSdpRemoveSpecialAttr(&(_descr)->iCommonFields,0,SDP_FIELDTYPE_MSRP_ACC_WRAPPED_TYPES)
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI void rvSdpMediaDescrDestroyMaxSizeAttr(RvSdpMediaDescr* descr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrDestroyMaxSizeAttr(_descr) \
  rvSdpRemoveSpecialAttr(&(_descr)->iCommonFields,0,SDP_FIELDTYPE_MSRP_MAX_SIZE)
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI void rvSdpMediaDescrDestroyPathAttr(RvSdpMediaDescr* descr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrDestroyPathAttr(_descr) \
   rvSdpRemoveSpecialAttr(&(_descr)->iCommonFields,0,SDP_FIELDTYPE_MSRP_PATH)
#endif /*RV_SDP_USE_MACROS*/


#endif /* RV_SDP_MSRP_ATTR */


#ifdef RV_SDP_MEDIA_GROUPING_ATTR
/*-----------------------------/
 * MEDIA ID (a=mid) attribute  
 *-----------------------------*/
 ...
 * ------------------------------------------------------------------------
 * General: 
 *      Gets the Mid Value of the SDP media descr as string. 
 *          
 * Return Value: 
 *      Returns the Mid Value as string.
 *      EMPTY STRING is returned if the correspondent attribute is not set.
 * ------------------------------------------------------------------------
 * Arguments:
 *      descr - a pointer to the RvSdpMediaDescr object.
 ***************************************************************************/
RVSDPCOREAPI const char* rvSdpMediaDescrGetMidValueStr(RvSdpMediaDescr* descr);
 ...
 *      descr - a pointer to the RvSdpMediaDescr object.
 ***************************************************************************/
RVSDPCOREAPI RvInt rvSdpMediaDescrGetMidValueAsInt(RvSdpMediaDescr* descr);
 ...
 * General: 
 *      Add/set special attribue to media descriptor level.
 *      Adds new attr if the val is legal and there is no such attribute yet.
 *      update the attr value if there is already legal one and new val is legal.
 *      or remove the attribute if val is NULL.
 *      NOTICE - Use this function only if this special attribute 
 *               can appear only once per media!
 *      
 * Return Value: 
 *      Returns RV_SDPSTATUS_OK if the function succeeds, or an error code if the 
 *      function fails.
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpStatus rvSdpMediaDescrSetMidValueStr(
                                                       RvSdpMediaDescr* descr,
                                                       const char     * midValStr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrSetMidValueStr(_descr,_midValStr) \
     rvSdpMediaDescrAddSpecAttr(_descr,_midValStr,SDP_FIELDTYPE_MEDIA_ID)
...
/***************************************************************************
 * rvSdpMediaDescrSetMidValueAsInt (int)
 * ------------------------------------------------------------------------
 * General: 
 *      Sets/modifies the Mid Value (as Int) of the SDP media descr level.
 *          
 * Return Value: 
 *      Returns RV_SDPSTATUS_OK if the function succeeds, or an error code if the 
 *      function fails.
 ...
 ***************************************************************************/
RVSDPCOREAPI RvSdpStatus rvSdpMediaDescrSetMidValueAsInt(
                                              RvSdpMediaDescr* descr,
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrDestroyMidAttr(_descr) \
   rvSdpRemoveSpecialAttr(&(_descr)->iCommonFields,0,SDP_FIELDTYPE_MEDIA_ID)
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General: This function gets a message and a mediaGroupAttr (a=group) and it returns a ptr 
 *          to the mediaDesc that is labled with a midId tag that appears in the 
 *          given index in the midId param list that appears in the media-group attribute.
 *
 * example: a=group:SRF 12 13 14 15 
 *          m= AUDIO .....
 *          a=mid 12
 *          m= VIDEO .....
 *          a=mid 13
 *
 *   for index=0 the ptr to the first media (AUDIO) will be returned
 *      
 * Return Value: a ptr to RvSdpMediaDescr that is represented in the group 
 *               attribute by a midId tag
 * ------------------------------------------------------------------------
 * Arguments:
 *      msg - a given message that from its media-group attribute we retrieve
 *            the media descriptor ptr.
 *      mediaGroupAttr - a pointer to the RvSdpMediaGroupAttr object in the msg.
 *      index    - the position of the mid-Id parameter in the mid-Id parameter list 
 *                 (in the media-group attribute)
 *
 ***************************************************************************/
RVSDPCOREAPI RvSdpMediaDescr* rvSdpMsgGetMediaDescrByGroup(
                                 RvSdpMsg           * msg,
...
*      index - the index. The index should start at zero (0) and must be smaller 
*              than the number of elements in the list. The number of elements 
*              in the list is retrieved by rvSdpMediaGroupAttrGetNumOfMidIdParams() call. 
***************************************************************************/
RVSDPCOREAPI const char* rvSdpMediaGroupAttrGetMid(
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpStatus rvSdpMediaGroupAttrAddMid(
                                 RvSdpMediaGroupAttr* mediaGroupAttr, 
                                 const char         * midTag);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaGroupAttrAddMid(_mediaGroupAttr,_midTag) \
            rvSdpAddTextToArray(&((_mediaGroupAttr)->iMidIdParamsNum),\
                                RV_SDP_MAX_NUM_OF_MID_ID_IN_LIST,\
                                (_mediaGroupAttr)->iMidIdParams,\
                                (_mediaGroupAttr)->iObj,\
                                (_midTag))
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General: 
 *      Removes one MidId tag parameter to the MediaGroup attribute by index.
 *          
 * Return Value: 
 *      Returns RV_SDPSTATUS_OK if the function succeeds, or an error code if the 
 *      function fails.
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS 
RVSDPCOREAPI void rvSdpMediaGroupAttrRemoveMid(
                                         RvSdpMediaGroupAttr* mediaGroupAttr, 
                                         RvSize_t             index);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaGroupAttrRemoveMid(_mediaGroupAttr,_index) \
       rvSdpRemoveTextFromArray(&((_mediaGroupAttr)->iMidIdParamsNum),\
                                 (_mediaGroupAttr)->iMidIdParams,\
                                 (_mediaGroupAttr)->iObj,\
                                 (_index))
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General: 
 *      Removes (and destructs) all midId parameters set in group special attribute.  
 *          
 * Return Value: 
 *      None.
 * ------------------------------------------------------------------------
 * Arguments:
 *      mediaGroup - a pointer to the RvSdpMediaGroupAttr object.
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI void rvSdpMediaGroupAttrClearMidParams(RvSdpMediaGroupAttr* mediaGroup);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaGroupAttrClearMidParams(_mediaGroup) \
            rvSdpClearTxtArray(&((_mediaGroup)->iMidIdParamsNum),\
                                 (_mediaGroup)->iMidIdParams, \
                                 (_mediaGroup)->iObj)
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General: 
 *      Gets the semantics text value of the media-group attribute ("LS"/"FID"/"SRF").
 *          
 * Return Value: 
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI const char* rvSdpMediaGroupAttrGetSemanticsStr(const RvSdpMediaGroupAttr* mediaGroupAttr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaGroupAttrGetSemanticsStr(_mediaGroupAttr) \
RV_SDP_EMPTY_STRING((_mediaGroupAttr)->ieSemanticsType)
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General: 
 *      Gets the semantics enum value of the media-group attribute ("LS"/"FID"/"SRF").
 *          
 * Return Value: 
 *      The requested field of the media-group attribute.
 * ------------------------------------------------------------------------
...
RVSDPCOREAPI RvSdpGroupSemanticsType rvSdpMediaGroupAttrGetSemantics
                                     (const RvSdpMediaGroupAttr* mediaGroupAttr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaGroupAttrGetSemantics(_mediaGroupAttr) \
               rvSdpGroupSemanticTypeTxt2Val(RV_SDP_EMPTY_STRING((_mediaGroupAttr)->ieSemanticsType))
#endif /*RV_SDP_USE_MACROS*/
 ...
 * Arguments:
 *      mediaGroupAttr - a pointer to the RvSdpMediaGroupAttr object.
 *      semanticsStr - the new value of semantics given as String
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaGroupAttrSetSemanticsStr(_mediaGroupAttr,_semanticsStr) \
    	(rvSdpSetTextField(&(_mediaGroupAttr)->ieSemanticsType,(_mediaGroupAttr)->iObj,(_semanticsStr)))
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General: 
 *      Sets the semantics as enum value in the media-group attribute ("LS"/"FID"/"SRF").
 *          
 * Return Value: 
 *      Returns RV_SDPSTATUS_OK if the function succeeds, or an error code if the 
 *      function fails.
 ...
 * Arguments:
 *      mediaGroupAttr - a pointer to the RvSdpMediaGroupAttr object.
 *      eSemantics - the new value of semantics given as enum val.
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaGroupAttrSetSemantics(_mediaGroupAttr,_eSemantics) \
(rvSdpMediaGroupAttrSetSemanticsStr((_mediaGroupAttr),\
                                    (rvSdpGroupSemanticTypeVal2Txt(_eSemantics))))
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaGroupAttrGetNumOfMidParams(_mediaGroupAttr) \
        (_mediaGroupAttr->iMidIdParamsNum)
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General:
 *      Gets the number of Media-Group special attributes set in SDP message context.
 *
 * Return Value:
 *      Number of Media-Group special attributes set in SDP message context.
 * ------------------------------------------------------------------------
 * Arguments:
 *      msg - a pointer to the RvSdpMsg object.
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSize_t rvSdpMsgGetNumOfMediaGroup(
                                                 const RvSdpMsg* msg);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMsgGetNumOfMediaGroup(_msg) \
            rvSdpGetNumOfSpecialAttr(&(_msg)->iCommonFields,SDP_FIELDTYPE_MEDIA_GROUP)
#endif /*RV_SDP_USE_MACROS*/
...
* ------------------------------------------------------------------------
* General: 
*      Gets a Media-Group attribute object by index. 
*          
* Return Value: 
*      The requested Media-Group attribute object.
* ------------------------------------------------------------------------
* Arguments:
*      msg - a pointer to the RvSdpMsg object.
*      index - the index. The index should start at zero (0) and must be smaller 
*              than the number of elements in the list. The number of elements 
*              in the list is retrieved by rvSdpMsgGetNumOfMediaGroup() call. 
***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpMediaGroupAttr* rvSdpMsgGetMediaGroup(
                                                        const RvSdpMsg* msg,
                                                        RvSize_t        index);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMsgGetMediaGroup(_msg,_index) \
(RvSdpMediaGroupAttr*)rvSdpGetSpecialAttr((RvSdpCommonFields*)&(_msg)->iCommonFields,\
                                          (_index),\
 ...
 * ------------------------------------------------------------------------
 * General:
 *      Returns the first Media-Group attribute object defined in the SDP message. 
 *      Also sets the list iterator for the further use.
 *
 * Return Value:
 *      Pointer to the RvSdpMediaGroupAttr object or the NULL pointer if there are no
 *      Media-Group special attributes defined in the SDP message.
 * ------------------------------------------------------------------------
 * Arguments:
 *      msg - a pointer to the RvSdpMsg object.
 *      iter - pointer to RvSdpListIter to be used for further
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpMediaGroupAttr* rvSdpMsgGetFirstMediaGroup(
                                                             RvSdpMsg     * msg,
                                                             RvSdpListIter* iter);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMsgGetFirstMediaGroup(_msg,_iter) \
    (RvSdpMediaGroupAttr*)rvSdpGetFirstSpecialAttr(&(_msg)->iCommonFields,\
                                                    (_iter),SDP_FIELDTYPE_MEDIA_GROUP)
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General:
 *      Returns the next Media-Group attribute object defined in the SDP message.
 *      The 'next' object is defined based on the list iterator state.
 *
 * Return Value:
 *      Pointer to the RvSdpMediaGroupAttr object or the NULL pointer if there are no
 *      more Media-Group special attributes defined in the SDP message.
 * ------------------------------------------------------------------------
 * Arguments:
 *      iter - pointer to RvSdpListIter set/modified by previous successfull call
 *             to GetFirst/GetNext function.
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpMediaGroupAttr* rvSdpMsgGetNextMediaGroup(
                                                            RvSdpListIter* iter);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMsgGetNextMediaGroup(_iter) \
            (RvSdpMediaGroupAttr*)rvSdpGetNextSpecialAttr((_iter),SDP_FIELDTYPE_MEDIA_GROUP)
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General: 
 *      Adds the new proprietary formatted RvSdpMediaGroupAttr object at the session level.
 *          
 * Return Value: 
 *      Returns the pointer to the newly created RvSdpMediaGroupAttr object if the 
 *      function succeeds or NULL pointer if the function fails.
 * ------------------------------------------------------------------------
 * Arguments:
 *      msg    - a pointer to the RvSdpMsg object.
 *      badSyn - the proprietary value of Media-Group special attribute.
 ***************************************************************************/
#if defined(RV_SDP_CHECK_BAD_SYNTAX)
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpMediaGroupAttr* rvSdpMsgAddBadSyntaxMediaGroup(
                                                           RvSdpMsg  * msg,
                                                           const char* badSyn);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMsgAddBadSyntaxMediaGroup(_msg,_MediaGroup) \
   rvSdpAddMediaGroupAttr2((_msg),&(_msg)->iCommonFields,"",(_MediaGroup))
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define  rvSdpMediaGroupAttrIsBadSyntax(_mediaGroupAttr) \
                   ((_mediaGroupAttr)->iBadSyntaxField != NULL)
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define  rvSdpMediaGroupAttrGetBadSyntax(_mediaGroupAttr) \
RV_SDP_EMPTY_STRING((_mediaGroupAttr)->iBadSyntaxField)
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrGetPrecondTypeStr(_precondAttr) RV_SDP_EMPTY_STRING((_precondAttr)->iPrecondType)
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrGetPrecondType(_precondAttr) \
rvSdpPreconditionTypeTxt2Val(RV_SDP_EMPTY_STRING((_precondAttr)->iPrecondType))
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrSetPrecondTypeStr(_precondAttr,_precondTypeStr) \
rvSdpSetTextField(&(_precondAttr)->iPrecondType,(_precondAttr)->iObj,(_precondTypeStr))
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrSetPrecondType(_precondAttr,_ePrecondType) \
(rvSdpPreconditionAttrSetPrecondTypeStr((_precondAttr),\
                                       (rvSdpPreconditionTypeVal2Txt(_ePrecondType))))
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI const char* rvSdpPreconditionAttrGetStatusStr(
                                               const RvSdpPreconditionAttr* precondAttr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrGetStatusStr(_precondAttr) RV_SDP_EMPTY_STRING((_precondAttr)->iStatusType)
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrGetStatus(_precondAttr) \
    rvSdpPreconditionStatusTxt2Val(RV_SDP_EMPTY_STRING((_precondAttr)->iStatusType))
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrSetStatusStr(_precondAttr,_precondStatusStr) \
   (rvSdpSetTextField(&(_precondAttr)->iStatusType,\
   (_precondAttr)->iObj,(_precondStatusStr)))
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrSetStatus(_precondAttr,_ePrecondStatus) \
(rvSdpPreconditionAttrSetStatusStr((_precondAttr),\
                                  (rvSdpPreconditionStatusVal2Txt(_ePrecondStatus))))
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI const char* rvSdpPreconditionAttrGetStrengthTagStr(
                                               const RvSdpPreconditionAttr* precondAttr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrGetStrengthTagStr(_precondAttr) \
     RV_SDP_EMPTY_STRING((_precondAttr)->iStrengthTag)
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrGetStrengthTag(_precondAttr) \
    rvSdpPreconditionStrengthTxt2Val(RV_SDP_EMPTY_STRING((_precondAttr)->iStrengthTag))
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrSetStrengthTagStr(_precondAttr,_strengthStr) \
rvSdpSetTextField(&(_precondAttr)->iStrengthTag,(_precondAttr)->iObj,(_strengthStr))
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI RvSdpStatus rvSdpPreconditionAttrSetStrengthTag(
                                            RvSdpPreconditionAttr *    precondAttr,
                                            RvSdpPreconditionStrengthTag      eStrength);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrSetStrengthTag(_precondAttr,_eStrength) \
     rvSdpPreconditionAttrSetStrengthTagStr((_precondAttr),\
                                            (rvSdpPreconditionStrengthVal2Txt(_eStrength)));
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI const char* rvSdpPreconditionAttrGetDirectionTagStr(
                                               const RvSdpPreconditionAttr* precondAttr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrGetDirectionTagStr(_precondAttr) \
     RV_SDP_EMPTY_STRING((_precondAttr)->iDirectionTag)
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrGetDirectionTag(_precondAttr) \
    rvSdpPreconditionDirectionTxt2Val(RV_SDP_EMPTY_STRING((_precondAttr)->iDirectionTag))
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrSetDirectionTagStr(_precondAttr,_directionStr) \
rvSdpSetTextField((&(_precondAttr)->iDirectionTag),((_precondAttr)->iObj),(_directionStr))
#endif /*RV_SDP_USE_MACROS*/
...
#else /*RV_SDP_USE_MACROS*/
#define rvSdpPreconditionAttrSetDirectionTag(_precondAttr,_eDirection) \
 (rvSdpPreconditionAttrSetDirectionTagStr((_precondAttr),\
                                          (rvSdpPreconditionDirectionVal2Txt(_eDirection))))
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpPreconditionAttr* rvSdpMediaDescrAddPrecondition(
                                                 RvSdpMediaDescr* descr,
                                                 RvSdpPrecondName precondName, 
                                                 const char*      typeStr, 
                                                 const char*      statusStr,
                                                 const char*      strengthStr,
                                                 const char*      directionStr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrAddPrecondition(_descr,_precondName,_typeStr,_statusStr,_strengthStr,_directionStr) \
           rvSdpAddPreconditionAttr2((_descr),&(_descr)->iCommonFields,\
                                      rvSdpPreconditionNameVal2Txt(_precondName),\
                                     (_typeStr),(_statusStr),(_strengthStr),(_directionStr),NULL)
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
RVSDPCOREAPI void rvSdpMediaDescrRemovePrecondition(
                                                 RvSdpMediaDescr* descr,
                                                 RvSdpPrecondName precondName,
												 RvSize_t index);
 ...
 *      precondName  - the precondition attribute type.
 ***************************************************************************/
RVSDPCOREAPI void rvSdpMediaDescrClearPrecondition(
					 RvSdpMediaDescr* descr,
					 RvSdpPrecondName precondName);
 ...
 *      descr - a pointer to the RvSdpMediaDescr object.
 ***************************************************************************/
RVSDPCOREAPI RvSize_t rvSdpMediaDescrGetNumOfPrecondition(
 ...
 ***************************************************************************/
RVSDPCOREAPI RvSdpPreconditionAttr* rvSdpMediaDescrGetFirstPrecondition(
                                                       RvSdpMediaDescr* descr,
                                                       RvSdpPrecondName ePrecondName,
                                                       RvSdpListIter  * iter);
 ...
 ***************************************************************************/
RVSDPCOREAPI RvSdpPreconditionAttr* rvSdpMediaDescrGetNextPrecondition(
                                             RvSdpPrecondName ePrecondName,
                                             RvSdpListIter* iter);
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI void rvSdpMediaDescrRemoveCurrentPrecondition(
                                             RvSdpListIter* iter);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrRemoveCurrentPrecondition(_iter) \
                rvSdpListRemoveCurrent((_iter))
#endif /*RV_SDP_USE_MACROS*/
 ...
 *              rvSdpMediaDescrGetNumOfPrecondition() call.
 ***************************************************************************/
RVSDPCOREAPI RvSdpPreconditionAttr* rvSdpMediaDescrGetPrecondition(
                    RvSdpMediaDescr      * descr,
                    RvSdpPrecondName       ePrecondName,
                    RvSize_t               index);
...
#else /*RV_SDP_USE_MACROS*/
#define  rvSdpPreconditionAttrIsBadSyntax(_precondAttr) \
                            ((_precondAttr)->iBadSyntaxField != NULL)
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI const char* rvSdpPreconditionAttrGetBadSyntax
                                     (const RvSdpPreconditionAttr* precondAttr);
#else /*RV_SDP_USE_MACROS*/
#define  rvSdpPreconditionAttrGetBadSyntax(_precondAttr) \
                           RV_SDP_EMPTY_STRING((_precondAttr)->iBadSyntaxField)
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvSdpPreconditionAttr* rvSdpMediaDescrAddBadSyntaxPrecondition(
                                                 RvSdpMediaDescr* descr,
                                                 const char     * badSyn);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrAddBadSyntaxPrecondition(_descr,_badSyn) \
           rvSdpAddPreconditionAttr2((_descr),&(_descr)->iCommonFields,\
                                      NULL,NULL,NULL,NULL,NULL,(_badSyn))
#endif /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General:
 *      Compares media descriptors.
 *
 * Return Value:
 *      RV_TRUE if one descriptor represents exact copy of the other.
 * ------------------------------------------------------------------------
 * Arguments:
 *      dest - a pointer to destination media descriptor. Must point
 *             to constructed RvSdpMediaDescr object.
 *      src - a source media descriptor.
 ***************************************************************************/
RVSDPCOREAPI RvBool rvSdpMediaDescrCompare(
                    const RvSdpMediaDescr* descr1,
                    const RvSdpMediaDescr* descr2);
...
RVSDPCOREAPI const char* rvSdpMediaDescrGetNASCtrlMethod(
                    RvSdpMediaDescr* descr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrGetNASCtrlMethod(_descr) RV_SDP_EMPTY_STRING((_descr)->iMediaNASCtrlMethod)
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI RvSdpStatus rvSdpMediaDescrSetNASCtrlMethod(
                    ...
                    const char* method);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrSetNASCtrlMethod(_descr,_method) \
                    rvSdpSetTextField(&(_descr)->iMediaNASCtrlMethod,(_descr)->iObj,(_method))
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI RvSize_t rvSdpMediaDescrGetVcIdNum(
                    const RvSdpMediaDescr* descr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrGetVcIdNum(_descr) ((_descr)->iMediaVcIdsNum)
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI RvSdpVcId rvSdpMediaDescrGetVcIdType(
                    ...
                    RvSize_t idx);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrGetVcIdType(_descr,_idx) ((_descr)->iMediaVcIdTypes[_idx])
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI const char* rvSdpMediaDescrGetVcIdValue (
                    ...
                    RvSize_t idx);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrGetVcIdValue(_descr,_idx) RV_SDP_EMPTY_STRING((_descr)->iMediaVcIdValues[_idx]);
#endif /*RV_SDP_USE_MACROS*/
...
RVSDPCOREAPI void rvSdpMediaDescrClearVcId (
                    RvSdpMediaDescr* descr);
#else /*RV_SDP_USE_MACROS*/
#define rvSdpMediaDescrClearVcId(_descr) \
    rvSdpClearTxtArray(&(_descr)->iMediaVcIdsNum,(_descr)->iMediaVcIdValues,(_descr)->iObj);
#endif /*RV_SDP_USE_MACROS*/
 ...
 ***************************************************************************/
#ifndef RV_SDP_USE_MACROS
RVSDPCOREAPI RvInt32 rvSdpMediaDescrGetPort(
                    const RvSdpMediaDescr* descr);
#else /*RV_SDP_USE_MACROS*/
 ...
 * ------------------------------------------------------------------------
 * General: 
 *      Gets codec's name (rtp->iEncName) according to a given payload.
 *          
 * Return Value: 
 *      the codec's Name string.
 * ------------------------------------------------------------------------
 * Arguments:
 *      descr - a pointer to the RvSdpMediaDescr object.
 *      payload   - the payload (representing a codec type) that
 *                  we're looking for it's name.
 ***************************************************************************/
RVSDPCOREAPI const char*  rvSdpMediaDescrGetCodecNameByPayload(const RvSdpMediaDescr* descr,
                                                               int       payload);
 ...
 * ------------------------------------------------------------------------
 * General:
 *      Appends the the constructed & valid SDP message to the list.
 *
 * Return Value:
 *      None.
 * ------------------------------------------------------------------------
 ...
 *      msg - pointer to constructed RvSdpMsg object.
 ***************************************************************************/
RVSDPCOREAPI void rvSdpMsgListAppendMsg(
            RvSdpMsgList* msgList, 
            const RvSdpMsg* msg);
...
#define rvSdpAttributeSetName(_attr,_name) \
    ...
    /***************************************************************************
     * rvSdpAttributeGetLabel
     * ------------------------------------------------------------------------
     * General:
     *      Get the attribute application set label.
     * Return Value:
     *      Returns the attribute label that could earlier be set by application.
     * ------------------------------------------------------------------------
     * Arguments:
     *      attr - a pointer to RvSdpAttribute object.
     ***************************************************************************/
    #define rvSdpAttributeGetLabel(_attr) ((_attr)->iLabel)

    /***************************************************************************
     * rvSdpAttributeSetLabel
     * ------------------------------------------------------------------------
     * General:
     ...
     * Arguments:
     *      attr - a pointer to RvSdpAttribute object.
     *      _label - the new attribute's label.
     ***************************************************************************/
    #define rvSdpAttributeSetLabel(_attr,_label) ((_attr)->iLabel = (_label))
...
#define RV_SDP_RTPMAP_FORMAT_ANY    -4
 ...
 * Return Value:
 *      Returns the payload number or RV_SDP_RTPMAP_FORMAT_ANY value if the
 *      the payload was set as '$' (Supported only if RV_SDP_MEGACO_EXTRA_ENABLED
 *      is defined in the rvsdpconfig.h)
 * ------------------------------------------------------------------------
 * Arguments:
 *      rtpMap - a pointer to the RvSdpRtpMap object.
 ***************************************************************************/
