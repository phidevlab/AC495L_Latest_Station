...
#define RTPLOG_ERROR(params) RvLogError(RTP_SOURCE, params)
    
    /* Log info macro with multiple parameters
    * Usage:
    *  RTPLOG_INFO((RTP_SOURCE, format,...));
    */
#define RTPLOG_INFO(params)  RvLogInfo(RTP_SOURCE, params)
    
    /* Log debug macro with multiple parameters
    * Usage:
    *  RTPLOG_DEBUG((RTP_SOURCE, format,...));
    */
#define RTPLOG_DEBUG(params)  RvLogDebug(RTP_SOURCE, params)
    /*
...
#define RTPLOG_ENTER(funcName) \
    RvLogEnter(RTP_SOURCE, (RTP_SOURCE, FUNC_NAME(funcName)))
...
#define RTPLOG_LEAVE(funcName) \
    RvLogLeave(RTP_SOURCE, (RTP_SOURCE, FUNC_NAME(funcName)))
    ...
    *    msg - message to log
    */
#define RTPLOG_ERROR1(func, msg) RTPLOG_ERROR((RTP_SOURCE, FUNC_NAME(func) " - " msg))
    ...
    *    msg - message to log
    */
#define RTPLOG_INFO1(func, msg)  VPHLOG_INFO((RTP_SOURCE, FUNC_NAME(func) " - " msg))
