/******************************************************************************
Filename:    sipTls.h
Description: This file includes TLS support in MTF.
*******************************************************************************
...
typedef struct 
{
	...
	RvString						stackTlsAddress;
        /* TLS address the stack will listen on.*/

	RvInt16							stackNumOfTlsAddresses;
        /* Number of TLS addresses the stack should listen on.*/
 ...
 *                 sipTransportEvHandlers - handle to the Callbacks
 *  Output:        None
**************************************************************************/
